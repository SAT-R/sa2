...
sub_801D24C: @ 0x0801D24C
	...
	mov ip, r5          @ ip = 0x3FF
	adds r5, r0, #0
	mov r6, ip          @ r6 = ip = 0x3FF
	ands r5, r6         @ r5 = stageTime & 0x3FF
	lsrs r7, r0, #1
	ands r7, r6         @ r7 = stageTime2 = ((gStageTime >> 1) & 0x3FF);
	lsls r2, r1, #0x10
	asrs r1, r2, #0xf   @ r1 = (p1 * 2)
	asrs r0, r2, #0x11
	adds r1, r1, r0
	movs r0, #0x9f
	subs r0, r0, r1
...
_0801D3BE:
	...
	b _0801D498
_0801D3D6:
	asrs r0, r2, #0x15      @ r0 = (p1 * 2)
	movs r1, #0x10
	subs r0, r1, r0         @ r0 = 16 - (p1 * 2)
	lsls r0, r0, #8
	orrs r0, r1
	mov r2, r8              @ r2 = r8 gBldRegs
	strh r0, [r2, #2]       @ gBldRegs.bldAlpha = ((16 - (p1 * 2)) << 8) | 16
	lsls r6, r6, #0x10      @ r6 = (r6 << 16)
	movs r4, #0
	mov sl, r6              @ sl = (r6 << 16)
	cmp r6, #0
	ble _0801D44C
...
_0801D44C:
	...
	cmp r0, #0x9e
	bgt _0801D498
	mov r5, sl          @ r5 = sl (r6 << 16)
	asrs r2, r5, #0x10  @ r2 = r6
	movs r5, #0xff
_0801D45A:
	movs r0, #0
	strh r0, [r3]
...
_0801D4B4:
	lsls r3, r5, #0x10
	asrs r3, r3, #0x10  @ r3 = i
	lsls r1, r3, #1
	adds r1, r1, r3
	adds r0, r6, #0
	adds r0, #0x30
	adds r0, r1, r0
	ldrb r7, [r0]       @ r7 = gUnknown_080D5C02[24 + i*3]
	ldr r5, [sp]        @ r5 = p0
	adds r4, r7, #0
	muls r4, r5, r4
	asrs r4, r4, #4     @ r4 = (p0 * gUnknown_080D5C02[24 + i*3]) >> 4;
	mov r0, ip
	ands r4, r0         @ r4 &= 0x1F
	adds r0, r6, #0
	adds r0, #0x31
