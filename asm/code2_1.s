...
_0806422C:
	...
	b _080642F0
_08064232:
	ldr r0, _08064260 @ =gRepeatedKeys
	ldrh r1, [r0]
	movs r0, #0x80
	ands r0, r1
	cmp r0, #0
...
sub_8064CEC: @ 0x08064CEC
	...
	ldr r0, [r0]
	mov sb, r0
	ldr r6, _08064D54 @ =gRepeatedKeys
	ldrh r1, [r6]
	movs r0, #0xc0
	ands r0, r1
	cmp r0, #0
...
_08064DCA:
	bl sub_806AD98
	ldr r0, _08064E08 @ =gRepeatedKeys
	ldrh r0, [r0]
	movs r5, #0xc0
	ands r5, r0
	cmp r5, #0
