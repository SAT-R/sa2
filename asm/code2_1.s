...
sub_8063A00: @ 0x08063A00
	...
	lsls r0, r0, #0x12
	adds r5, r3, r0
	ldr r1, _08063A70 @ =IWRAM_START + 0x14C
	adds r0, r3, r1
	str r6, [r0]
	...
	ldrb r0, [r0, #6]
	subs r0, #1
	ldr r1, _08063A78 @ =IWRAM_START + 0x3BA
	adds r2, r3, r1
	strb r0, [r2]
	movs r1, #1
	cmp r4, #1
	...
	movs r1, #2
_08063A42:
	ldr r4, _08063A7C @ =IWRAM_START + 0x3BB
	adds r0, r3, r4
	strb r1, [r0]
	ldr r1, _08063A80 @ =IWRAM_START + 0x252
	adds r0, r3, r1
	strb r6, [r0]
	ldrb r2, [r2]
	cmp r2, #0
	...
	movs r1, #0
	strh r2, [r0]
	ldr r4, _08063A84 @ =IWRAM_START + 0x253
	adds r0, r3, r4
	strb r1, [r0]
	ldr r1, _08063A88 @ =IWRAM_START + 0x250
	adds r0, r3, r1
	strh r2, [r0]
	b _08063AA2
	.align 2, 0
_08063A6C: .4byte sub_806B354
_08063A70: .4byte IWRAM_START + 0x14C
_08063A74: .4byte gLoadedSaveGame
_08063A78: .4byte IWRAM_START + 0x3BA
_08063A7C: .4byte IWRAM_START + 0x3BB
_08063A80: .4byte IWRAM_START + 0x252
_08063A84: .4byte IWRAM_START + 0x253
_08063A88: .4byte IWRAM_START + 0x250
_08063A8C:
	ldr r2, _08063B14 @ =IWRAM_START + 0x3B8
	adds r0, r3, r2
	movs r2, #0
	movs r1, #0x63
	strh r1, [r0]
	ldr r4, _08063B18 @ =IWRAM_START + 0x253
	adds r0, r3, r4
	strb r2, [r0]
	ldr r2, _08063B1C @ =IWRAM_START + 0x250
	adds r0, r3, r2
	strh r1, [r0]
_08063AA2:
...
_08063AC0:
	...
	bx r0
	.align 2, 0
_08063B14: .4byte IWRAM_START + 0x3B8
_08063B18: .4byte IWRAM_START + 0x253
_08063B1C: .4byte IWRAM_START + 0x250
...
_0806422C:
	...
	b _080642F0
_08064232:
	ldr r0, _08064260 @ =gRepeatPressedKeys
	ldrh r1, [r0]
	movs r0, #0x80
	ands r0, r1
	cmp r0, #0
	...
	b _0806426C
	.align 2, 0
_08064260: .4byte gRepeatPressedKeys
...
sub_8064304: @ 0x08064304
	...
	movs r2, #0
	ldrsb r2, [r0, r2]
	ldr r4, _0806449C @ =IWRAM_START + 0x360
	adds r0, r5, r4
	movs r7, #0
	strh r2, [r0]
	lsls r2, r2, #0x10
...
_0806449C: .4byte IWRAM_START + 0x360
...
sub_80644C4: @ 0x080644C4
	...
	adds r1, r1, r2
	ldrh r2, [r1]
	ldr r3, _080645BC @ =IWRAM_START + 0x360
	adds r0, r5, r3
	movs r7, #0
	strh r2, [r0]
...
_080645BC: .4byte IWRAM_START + 0x360
...
sub_80645E0: @ 0x080645E0
	...
	adds r1, r1, r2
	ldrh r2, [r1]
	ldr r3, _080646D8 @ =IWRAM_START + 0x360
	adds r0, r5, r3
	movs r7, #0
	strh r2, [r0]
...
_080646D8: .4byte IWRAM_START + 0x360
...
sub_80646FC: @ 0x080646FC
	...
	movs r1, #0
	bl sub_8063D20
	ldr r1, _080647BC @ =IWRAM_START + 0x364
	adds r0, r7, r1
	movs r1, #0x1e
	mov r8, r1
	str r1, [sp]
	...
	movs r3, #0x85
	bl sub_806B854
	ldr r1, _080647C0 @ =IWRAM_START + 0x3A4
	adds r0, r7, r1
	mov r1, r8
	str r1, [sp]
	str r4, [sp, #4]
...
_080647BC: .4byte IWRAM_START + 0x364
_080647C0: .4byte IWRAM_START + 0x3A4
...
sub_80647C8: @ 0x080647C8
	...
	movs r1, #0
	bl sub_8063D20
	ldr r1, _08064890 @ =IWRAM_START + 0x364
	adds r0, r7, r1
	movs r1, #0x1e
	mov r8, r1
	str r1, [sp]
	...
	movs r3, #0x85
	bl sub_806B854
	ldr r1, _08064894 @ =IWRAM_START + 0x3A4
	adds r0, r7, r1
	mov r1, r8
	str r1, [sp]
	str r4, [sp, #4]
...
_08064890: .4byte IWRAM_START + 0x364
_08064894: .4byte IWRAM_START + 0x3A4
...
sub_806489C: @ 0x0806489C
	...
	adds r5, r7, r0
	ldr r1, _08064984 @ =IWRAM_START + 0x35B
	adds r4, r7, r1
	ldrb r0, [r4]
	mov sl, r0
...
_080648EC:
	...
	movs r1, #0
	bl sub_8063D20
	ldr r1, _08064998 @ =IWRAM_START + 0x364
	adds r0, r7, r1
	movs r1, #0x1e
	mov sl, r1
	str r1, [sp]
	...
	movs r3, #0x85
	bl sub_806B854
	ldr r1, _0806499C @ =IWRAM_START + 0x3A4
	adds r0, r7, r1
	mov r1, sl
	str r1, [sp]
	str r4, [sp, #4]
...
_08064984: .4byte IWRAM_START + 0x35B
...
_08064998: .4byte IWRAM_START + 0x364
_0806499C: .4byte IWRAM_START + 0x3A4
...
sub_80649A4: @ 0x080649A4
	...
	adds r0, r0, r1
	mov sb, r0
	ldr r2, _08064A38 @ =IWRAM_START + 0x3E4
	adds r0, r1, r2
	adds r2, #0x30
	adds r7, r1, r2
...
_08064A38: .4byte IWRAM_START + 0x3E4
...
sub_8064C44: @ 0x08064C44
	...
	adds r1, #0x60
	adds r4, r0, r1
	ldr r2, _08064CDC @ =IWRAM_START + 0x120
	adds r7, r0, r2
	ldr r5, _08064CE0 @ =IWRAM_START + 0x15C
	adds r0, r0, r5
	ldr r0, [r0]
	movs r1, #0xd8
	lsls r1, r1, #2
...
_08064CDC: .4byte IWRAM_START + 0x120
_08064CE0: .4byte IWRAM_START + 0x15C
...
sub_8064CEC: @ 0x08064CEC
	...
	adds r0, #0x60
	adds r5, r4, r0
	ldr r1, _08064D4C @ =IWRAM_START + 0x120
	adds r1, r1, r4
	mov r8, r1
	ldr r1, _08064D50 @ =IWRAM_START + 0x15C
	adds r0, r4, r1
	ldr r0, [r0]
	mov sb, r0
	ldr r6, _08064D54 @ =gRepeatPressedKeys
	ldrh r1, [r6]
	movs r0, #0xc0
	ands r0, r1
	cmp r0, #0
	...
	cmp r3, #0
	beq _08064D62
	ldr r0, _08064D58 @ =IWRAM_START + 0x160
	adds r1, r4, r0
	ldrb r2, [r1]
	movs r0, #0
	ldrsb r0, [r1, r0]
...
_08064D4C: .4byte IWRAM_START + 0x120
_08064D50: .4byte IWRAM_START + 0x15C
_08064D54: .4byte gRepeatPressedKeys
_08064D58: .4byte IWRAM_START + 0x160
_08064D5C:
	movs r0, #3
	strb r0, [r1]
	b _08064D86
_08064D62:
	...
	cmp r0, #0
	beq _08064D86
	ldr r0, _08064D80 @ =IWRAM_START + 0x160
	adds r1, r4, r0
	ldrb r2, [r1]
	movs r0, #0
	ldrsb r0, [r1, r0]
	...
	b _08064D86
	.align 2, 0
_08064D80: .4byte IWRAM_START + 0x160
_08064D84:
	strb r3, [r1]
_08064D86:
	movs r0, #0
...
_08064DCA:
	bl sub_806AD98
	ldr r0, _08064E08 @ =gRepeatPressedKeys
	ldrh r0, [r0]
	movs r5, #0xc0
	ands r5, r0
	cmp r5, #0
	...
	b _08064E54
	.align 2, 0
_08064E08: .4byte gRepeatPressedKeys
...
sub_8064E6C: @ 0x08064E6C
	...
	adds r1, #0x60
	adds r5, r0, r1
	ldr r3, _08064EFC @ =IWRAM_START + 0x120
	adds r3, r3, r0
	mov r8, r3
	ldr r7, _08064F00 @ =IWRAM_START + 0x15C
	adds r0, r0, r7
	ldr r0, [r0]
	movs r1, #0xd8
	lsls r1, r1, #2
...
_08064EFC: .4byte IWRAM_START + 0x120
_08064F00: .4byte IWRAM_START + 0x15C
...
sub_8064F1C: @ 0x08064F1C
	...
	adds r0, r0, r6
	mov sb, r0
	ldr r1, _08064FE8 @ =IWRAM_START + 0x150
	adds r5, r6, r1
	adds r1, #0x13
	adds r0, r6, r1
	movs r7, #0
	...
	str r7, [r0]
	ldr r0, _08064FF8 @ =IWRAM_START + 0x15C
	adds r6, r6, r0
	ldr r0, [r6]
	movs r1, #1
	bl sub_8063D20
...
sub_8065004: @ 0x08065004
	...
	lsls r0, r0, #0x12
	adds r6, r5, r0
	ldr r0, _08065044 @ =IWRAM_START + 0x150
	adds r4, r5, r0
	bl sub_806AD98
	adds r0, r4, #0
	bl sub_802D4CC
	...
	cmp r0, #0
	beq _08065076
	ldr r1, _08065048 @ =IWRAM_START + 0x15C
	adds r0, r5, r1
	ldr r0, [r0]
...
_08065044: .4byte IWRAM_START + 0x150
_08065048: .4byte IWRAM_START + 0x15C
...
sub_806508C: @ 0x0806508C
	...
	adds r0, r0, r6
	mov sb, r0
	ldr r1, _08065158 @ =IWRAM_START + 0x150
	adds r5, r6, r1
	adds r1, #0x13
	adds r0, r6, r1
	movs r7, #0
	...
	str r7, [r0]
	ldr r0, _08065168 @ =IWRAM_START + 0x15C
	adds r6, r6, r0
	ldr r0, [r6]
	movs r1, #1
	bl sub_8063D20
...
sub_8065174: @ 0x08065174
	...
	adds r0, r0, r6
	mov sb, r0
	ldr r1, _08065240 @ =IWRAM_START + 0x150
	adds r5, r6, r1
	adds r1, #0x13
	adds r0, r6, r1
	movs r7, #0
	...
	str r7, [r0]
	ldr r0, _08065250 @ =IWRAM_START + 0x15C
	adds r6, r6, r0
	ldr r0, [r6]
	movs r1, #1
	bl sub_8063D20
...
sub_806548C: @ 0x0806548C
	...
	lsrs r0, r0, #0x10
	mov sl, r0
	ldr r0, _080655A4 @ =gRepeatPressedKeys
	ldrh r1, [r0]
	movs r0, #0x30
	ands r0, r1
	cmp r0, #0
...
_080655A4: .4byte gRepeatPressedKeys
...
sub_80658E0: @ 0x080658E0
	...
	lsrs r0, r0, #0x10
	mov sl, r0
	ldr r0, _080659F8 @ =gRepeatPressedKeys
	ldrh r1, [r0]
	movs r0, #0x30
	ands r0, r1
	cmp r0, #0
...
_080659F8: .4byte gRepeatPressedKeys
...
sub_8066004: @ 0x08066004
	...
	mov r8, r0
	bl sub_8066818
	ldr r7, _08066078 @ =gRepeatPressedKeys
	ldrh r1, [r7]
	movs r0, #0x30
	ands r0, r1
	cmp r0, #0
...
_08066078: .4byte gRepeatPressedKeys
...
sub_8066220: @ 0x08066220
	...
	mov r8, r0
	bl sub_8066818
	ldr r5, _0806628C @ =gRepeatPressedKeys
	ldrh r1, [r5]
	movs r0, #0x30
	ands r0, r1
	cmp r0, #0
...
_0806628C: .4byte gRepeatPressedKeys
...
sub_8066B0C: @ 0x08066B0C
	...
	adds r5, r4, r0
	bl sub_806B1B8
	ldr r0, _08066B48 @ =gRepeatPressedKeys
	ldrh r1, [r0]
	movs r0, #0x80
	ands r0, r1
	cmp r0, #0
...
_08066B48: .4byte gRepeatPressedKeys
...
_08066B88:
	bl sub_806B1F8
	ldr r0, _08066BCC @ =gRepeatPressedKeys
	ldrh r1, [r0]
	movs r0, #0xc0
	ands r0, r1
	cmp r0, #0
	...
	b _08066C1C
	.align 2, 0
_08066BCC: .4byte gRepeatPressedKeys
...
sub_8066FAC: @ 0x08066FAC
	...
	adds r7, r4, r1
	ldr r0, _08067068 @ =gRepeatPressedKeys
	ldrh r1, [r0]
	movs r0, #0x30
	ands r0, r1
	cmp r0, #0
...
_08067068: .4byte gRepeatPressedKeys
...
sub_8067148: @ 0x08067148
	...
	adds r7, r4, r1
	ldr r0, _08067200 @ =gRepeatPressedKeys
	ldrh r1, [r0]
	movs r0, #0x30
	ands r0, r1
	cmp r0, #0
...
_08067200: .4byte gRepeatPressedKeys
...
_08067854:
	...
	b _08067B72
_08067860:
	ldr r0, _080678EC @ =gRepeatPressedKeys
	ldrh r2, [r0]
	movs r0, #1
	ands r0, r2
	cmp r0, #0
...
_080678EC: .4byte gRepeatPressedKeys
...
sub_8067B90: @ 0x08067B90
	...
	ldr r0, [r0]
	ldrh r1, [r0, #6]
	ldr r0, _08067BF4 @ =gRepeatPressedKeys
	ldrh r2, [r0]
	movs r0, #0x80
	lsls r0, r0, #2
	ands r0, r2
...
_08067BF4: .4byte gRepeatPressedKeys
...
sub_8067C50: @ 0x08067C50
	...
	ldr r0, [r0]
	ldrh r4, [r0, #6]
	ldr r5, _08067CA0 @ =gRepeatPressedKeys
	ldrh r1, [r5]
	movs r0, #0xf0
	ands r0, r1
	cmp r0, #0
...
_08067CA0: .4byte gRepeatPressedKeys
...
sub_8068474: @ 0x08068474
	...
	ldr r0, [r0]
	ldrh r4, [r0, #6]
	ldr r0, _080684B8 @ =gRepeatPressedKeys
	ldrh r1, [r0]
	movs r0, #0x30
	ands r0, r1
	cmp r0, #0
...
_080684B8: .4byte gRepeatPressedKeys
...
_080684D4:
	bl sub_806B4F8
	ldr r0, _08068504 @ =gRepeatPressedKeys
	ldrh r1, [r0]
	movs r0, #0x30
	ands r0, r1
	cmp r0, #0
...
_08068504: .4byte gRepeatPressedKeys
...
_0806923A:
	movs r0, #0
	bl sub_806979C
	ldr r7, _080692AC @ =gRepeatPressedKeys
	ldrh r1, [r7]
	movs r0, #0x30
	ands r0, r1
	cmp r0, #0
...
_080692AC: .4byte gRepeatPressedKeys
...
sub_806A0F4: @ 0x0806A0F4
	...
	ldr r6, [r0]
	bl sub_806A348
	ldr r0, _0806A148 @ =gRepeatPressedKeys
	ldrh r1, [r0]
	movs r0, #0xc0
	ands r0, r1
	cmp r0, #0
...
_0806A148: .4byte gRepeatPressedKeys
...
_0806A1B0:
	ldr r0, _0806A1CC @ =gRepeatPressedKeys
	ldrh r1, [r0]
	movs r0, #2
	ands r0, r1
	cmp r0, #0
...
_0806A1C6:
	...
	bx r0
	.align 2, 0
_0806A1CC: .4byte gRepeatPressedKeys
