...
sub_8063A00: @ 0x08063A00
	...
	adds r0, r3, r1
	str r6, [r0]
	ldr r0, _08063A74 @ =gLoadedSaveGame
	ldr r0, [r0]
	ldrb r0, [r0, #6]
	subs r0, #1
...
_08063A74: .4byte gLoadedSaveGame
...
sub_8063B38: @ 0x08063B38
	push {r4, r5, r6, r7, lr}
	adds r5, r0, #0
	ldr r0, _08063C5C @ =gLoadedSaveGame
	ldr r4, [r0]
	adds r6, r5, #0
	adds r1, r5, #0
	adds r0, r4, #0
...
_08063C54:
	...
	bx r0
	.align 2, 0
_08063C5C: .4byte gLoadedSaveGame
...
sub_8063C7C: @ 0x08063C7C
	push {r4, r5, r6, lr}
	adds r4, r0, #0
	ldr r0, _08063D0C @ =gLoadedSaveGame
	ldr r5, [r0]
	adds r1, r5, #0
	adds r1, #0x20
	adds r0, r4, #0
	...
	bx r0
	.align 2, 0
_08063D0C: .4byte gLoadedSaveGame
