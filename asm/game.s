...
sub_801A770: @ 0x0801A770
	...
	strb r1, [r0]
	ldr r1, _0801A7E8 @ =gCourseTime
	movs r0, #0
	strh r0, [r1]
	ldr r1, _0801A7EC @ =gUnknown_030054F8
	movs r0, #1
	strb r0, [r1]
	ldr r1, _0801A7F0 @ =gCurrentLevel
	movs r0, #0
	ldrsb r0, [r1, r0]
	cmp r0, #0x1d
	beq _0801A7AE
	ldr r0, _0801A7F4 @ =gSelectedCharacter
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	ldrb r1, [r1]
...
_0801A7AE:
	...
	ands r0, r1
	strh r0, [r2]
	ldr r2, _0801A80C @ =gGameMode
	ldrb r0, [r2]
	cmp r0, #2
	bls _0801A7CE
	ldr r0, _0801A810 @ =gUnknown_030054A0
	ldr r1, _0801A814 @ =gFrameCount
	ldr r1, [r1]
	str r1, [r0]
_0801A7CE:
...
_0801A7E8: .4byte gCourseTime
_0801A7EC: .4byte gUnknown_030054F8
_0801A7F0: .4byte gCurrentLevel
_0801A7F4: .4byte gSelectedCharacter
_0801A7F8: .4byte gPlayer
...
_0801A80C: .4byte gGameMode
_0801A810: .4byte gUnknown_030054A0
_0801A814: .4byte gFrameCount
...
sub_801A838: @ 0x0801A838
	...
	strb r4, [r0]
	ldr r4, _0801A958 @ =gCurrentLevel
	movs r0, #0
	ldrsb r0, [r4, r0]
	cmp r0, #0x1d
	beq _0801A8A0
	ldr r0, _0801A95C @ =gSelectedCharacter
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	movs r1, #0
	ldrsb r1, [r4, r1]
	ldr r2, _0801A960 @ =gPlayer
	bl sub_80213C0
_0801A8A0:
	ldrb r1, [r4]
	movs r0, #3
...
_0801A8BC:
	...
	ldr r6, _0801A958 @ =gCurrentLevel
	ldrb r0, [r6]
	lsls r0, r0, #0x18
	asrs r2, r0, #0x18
	asrs r0, r0, #0x1a
...
_0801A958: .4byte gCurrentLevel
_0801A95C: .4byte gSelectedCharacter
_0801A960: .4byte gPlayer
...
_0801A97C:
	...
	strh r0, [r2]
_0801A99E:
	ldr r0, _0801AA60 @ =gCurrentLevel
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	cmp r0, #0
...
_0801AA1E:
	...
	movs r1, #0
	strb r1, [r0]
	ldr r0, _0801AA98 @ =gMultiplayerConnections
	ldrb r0, [r0]
	asrs r0, r4
	movs r1, #1
	ands r0, r1
...
_0801AA98: .4byte gMultiplayerConnections
...
_0801ACBE:
	...
	strb r7, [r0]
_0801ACC4:
	ldr r0, _0801AD4C @ =gMultiplayerConnections
	ldrb r0, [r0]
	adds r2, #0x66
	ldrb r1, [r2]
	asrs r0, r1
...
_0801AD36:
	...
	b _0801AD76
	.align 2, 0
_0801AD4C: .4byte gMultiplayerConnections
...
_0801ADA8: .4byte gCurrentLevel
_0801ADAC: .4byte gPlayer
_0801ADB0:
	adds r0, r2, #0
	orrs r0, r4
	strh r0, [r3]
...
_0801AE0C: .4byte gGameMode
_0801AE10: .4byte gLoadedSaveGame
_0801AE14: .4byte gPlayer
