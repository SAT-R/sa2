...
.text
	...
	thumb_func_start CreateItemTask_Shield_Normal
CreateItemTask_Shield_Normal: @ 0x0802A7A8
	push {r4, r5, r6, lr}
	mov r6, sb
	mov r5, r8
	push {r5, r6}
	...
	lsls r6, r6, #0x18
	lsrs r6, r6, #0x18
	ldr r0, _0802A830 @ =Task_Item_Shield_Normal
	ldr r2, _0802A834 @ =0x00004001
	ldr r1, _0802A838 @ =TaskDestructor_ItemTasks
	str r1, [sp]
	movs r1, #0x38
	movs r3, #0
	bl TaskCreate
	...
	lsls r0, r0, #6
	str r0, [r5, #0x10]
	movs r0, #0x97      @ SE_ACTIVATE_SHIELD
	bl m4aSongNumStart
	mov r0, sb
	add sp, #4
	pop {r3, r4}
	...
	bx r1
	.align 2, 0
_0802A830: .4byte Task_Item_Shield_Normal
_0802A834: .4byte 0x00004001
_0802A838: .4byte TaskDestructor_ItemTasks
...
_0802A850: .4byte IWRAM_START + 0x25
	...
	thumb_func_start CreateItemTask_Invincibility
CreateItemTask_Invincibility: @ 0x0802A854
	push {r4, r5, r6, lr}
	mov r6, sb
	mov r5, r8
	push {r5, r6}
	...
	lsls r6, r6, #0x18
	lsrs r6, r6, #0x18
	ldr r0, _0802A8D8 @ =Task_Item_Invincibility
	ldr r2, _0802A8DC @ =0x00004001
	ldr r1, _0802A8E0 @ =TaskDestructor_ItemTasks
	str r1, [sp]
	movs r1, #0x38
	movs r3, #0
	bl TaskCreate
	...
	strh r0, [r5, #8]
	movs r0, #0xd5
	lsls r0, r0, #2     @ 852 - Invincibility Particles
	strh r0, [r5, #0xa]
	...
	bx r1
	.align 2, 0
_0802A8D8: .4byte Task_Item_Invincibility
_0802A8DC: .4byte 0x00004001
_0802A8E0: .4byte TaskDestructor_ItemTasks
...
_0802A8F4: .4byte IWRAM_START + 0x25
	...
	thumb_func_start CreateItemTask_Shield_Magnetic
CreateItemTask_Shield_Magnetic: @ 0x0802A8F8
	push {r4, r5, r6, lr}
	mov r6, r8
	push {r6}
	sub sp, #4
	...
	lsls r4, r4, #0x18
	lsrs r4, r4, #0x18
	ldr r0, _0802A980 @ =Task_Item_Shield_Magnetic
	ldr r2, _0802A984 @ =0x00004001
	ldr r1, _0802A988 @ =TaskDestructor_ItemTasks
	str r1, [sp]
	movs r1, #0x38
	movs r3, #0
	bl TaskCreate
	...
	bx r1
	.align 2, 0
_0802A980: .4byte Task_Item_Shield_Magnetic
_0802A984: .4byte 0x00004001
_0802A988: .4byte TaskDestructor_ItemTasks
...
CreateItemTask_Confusion: @ 0x0802A9A4
	push {r4, r5, r6, lr}
	mov r6, r8
	push {r6}
	sub sp, #4
	...
	lsls r4, r4, #0x18
	lsrs r4, r4, #0x18
	ldr r0, _0802AA24 @ =Task_Item_Confusion
	ldr r2, _0802AA28 @ =0x00004001
	ldr r1, _0802AA2C @ =TaskDestructor_ItemTasks
	str r1, [sp]
	movs r1, #0x38
	movs r3, #0
	bl TaskCreate
	...
	bx r1
	.align 2, 0
_0802AA24: .4byte Task_Item_Confusion
_0802AA28: .4byte 0x00004001
_0802AA2C: .4byte TaskDestructor_ItemTasks
