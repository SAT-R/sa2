...
_08011CB4:
	ldr r0, _08011D3C @ =Task_8012034
	ldr r2, _08011D40 @ =0x00004001
	ldr r1, _08011D44 @ =TaskDestructor_80124B8
	str r1, [sp]
	movs r1, #0x5c
	movs r3, #0
	bl TaskCreate
...
_08011D30:
	...
	bx r1
	.align 2, 0
_08011D3C: .4byte Task_8012034
_08011D40: .4byte 0x00004001
_08011D44: .4byte TaskDestructor_80124B8
...
_08011DA8:
	strh r0, [r1]
	movs r0, #0x79  @ SE_TAILS_TAIL_SWIPE
	bl m4aSongNumStart
	ldr r0, _08011DC4 @ =gPlayer
	ldr r1, _08011DC8 @ =PlayerCB_8011DCC
	str r1, [r0]
	adds r0, r4, #0
	bl _call_via_r1
	pop {r4}
...
_08011DC8: .4byte PlayerCB_8011DCC

	thumb_func_start PlayerCB_8011DCC
PlayerCB_8011DCC: @ 0x08011DCC
	push {r4, lr}
	adds r4, r0, #0
	movs r1, #0x14
	ldrsh r0, [r4, r1]
...
_08011E22:
	...
	ldr r0, _08011E54 @ =PlayerCB_8011E88
	str r0, [r1]
	adds r0, r4, #0
	adds r0, #0x5a
	ldrb r0, [r0]
...
_08011E54: .4byte PlayerCB_8011E88
_08011E58:
	movs r0, #0x80
	lsls r0, r0, #3
	strh r0, [r4, #0x14]
...
_08011E7C:
	...
	thumb_func_start PlayerCB_8011E88
PlayerCB_8011E88: @ 0x08011E88
	push {r4, lr}
	adds r4, r0, #0
	movs r1, #0x14
	ldrsh r0, [r4, r1]
...
_08011EE2:
	...
	ldr r0, _08011F18 @ =PlayerCB_80123D0
	str r0, [r1]
_08011EF6:
	adds r0, r4, #0
	bl sub_8027EF0
...
_08011F70:
	...
	ldr r1, _08011F90 @ =PlayerCB_80123FC
	str r1, [r0]
	adds r0, r4, #0
	bl _call_via_r1
	pop {r4, r5}
...
_08011F90: .4byte PlayerCB_80123FC

	thumb_func_start PlayerCB_8011F94
PlayerCB_8011F94: @ 0x08011F94
	push {r4, r5, r6, lr}
	adds r4, r0, #0
	ldrh r0, [r4, #0x12]
	adds r0, #0x38
...
_08011FE4:
	...
	ldr r0, _0801202C @ =PlayerCB_8012460
	str r0, [r1]
	movs r0, #2
	orrs r5, r0
	str r5, [r4, #0x20]
...
_0801202C: .4byte PlayerCB_8012460
_08012030: .4byte 0x0000FFFF

	thumb_func_start Task_8012034
Task_8012034: @ 0x08012034
	push {r4, r5, lr}
	sub sp, #8
...
_0801213C:
	...
	ldr r1, _08012190 @ =PlayerCB_80261D8
	str r1, [r0]
	adds r0, r6, #0
	bl _call_via_r1
	pop {r4, r5, r6}
...
_08012190: .4byte PlayerCB_80261D8
...
sub_8012194: @ 0x08012194
	...
	movs r0, #0x3c
	strh r0, [r1]
	movs r0, #0x70  @ SE_SONIC_MIDAIR_SOMERSAULT
	bl m4aSongNumStart
	ldr r0, _08012254 @ =gPlayer
	ldr r1, _08012258 @ =PlayerCB_80124D0
	str r1, [r0]
	adds r0, r6, #0
	bl _call_via_r1
	pop {r4, r5, r6}
...
_08012258: .4byte PlayerCB_80124D0
...
_0801259E:
	...
	ldr r1, _080125B8 @ =PlayerCB_80127F0
	str r1, [r0]
	adds r0, r4, #0
	bl _call_via_r1
	pop {r4}
...
_080125B8: .4byte PlayerCB_80127F0
...
_0801266E:
	...
	orrs r0, r1
	str r0, [r2, #0x20]
	ldr r1, _080126AC @ =PlayerCB_80126B0
	str r1, [r2]
	adds r0, r4, #0
	bl _call_via_r1
	pop {r4}
...
_080126AC: .4byte PlayerCB_80126B0
