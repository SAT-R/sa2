...
.arm
	...
	thumb_func_start Task_8060D34
Task_8060D34: @ 0x08060D34
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_08060F4C:
	...
	ldr r1, [r0]
	ldr r0, _08060F5C @ =Task_8060D34
	str r0, [r1, #8]
	b _08061072
	.align 2, 0
_08060F58: .4byte gCurTask
_08060F5C: .4byte Task_8060D34
_08060F60:
	lsls r1, r3, #4
	subs r1, r1, r3
	lsls r0, r1, #5
...
_08061010:
	...
	b _08061072
_08061044:
	ldr r1, _08061080 @ =PlayerCharIdleAnims
	adds r0, r4, #0
	adds r0, #0x85
	ldrb r0, [r0]
	lsls r0, r0, #0x18
...
_08061072:
	...
	bx r0
	.align 2, 0
_08061080: .4byte PlayerCharIdleAnims
...
_0806136C:
	...
	b _080613CE
_080613A0:
	ldr r1, _080613DC @ =PlayerCharIdleAnims
	adds r0, r4, #0
	adds r0, #0x85
	ldrb r0, [r0]
	lsls r0, r0, #0x18
...
_080613CE:
	...
	bx r0
	.align 2, 0
_080613DC: .4byte PlayerCharIdleAnims
