...
_08086516:
	...
	adds r0, r5, r0
	strh r0, [r1]
	ldr r0, _080865A8 @ =gSelectedLevel
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	cmp r0, #0x1d
...
_080865A8: .4byte gSelectedLevel
...
sub_8086CE8: @ 0x08086CE8
	...
	lsls r0, r0, #0x12
	adds r4, r2, r0
	ldr r0, _08086D58 @ =gSelectedLevel
	ldrb r3, [r0]
	lsls r1, r3, #0x18
	asrs r1, r1, #0x19
	movs r0, #1
...
_08086D58: .4byte gSelectedLevel
...
_08088DB4:
	...
	lsrs r1, r1, #0x18
	bl sub_803143C
	ldr r1, _08088DDC @ =gSelectedLevel
	movs r0, #0
	strb r0, [r1]
	b _08088EAC
	.align 2, 0
...
_08088DDC: .4byte gSelectedLevel
_08088DE0:
	...
	lsls r1, r1, #0x18
	asrs r1, r1, #0x18
	ldr r2, _08088E08 @ =gSelectedLevel
	ldrb r2, [r2]
	lsls r2, r2, #0x18
	asrs r2, r2, #0x18
	bl sub_80637EC
...
_08088E08: .4byte gSelectedLevel
_08088E0C:
	bl sub_808D41C_CreateTitleScreenSkipIntro
	b _08088EAC
_08088E12:
...
_0808943E:
	...
	adds r0, r7, #0
	bl sub_8004558
	ldr r1, _080895E8 @ =gSelectedLevel
	mov sb, r1
	ldrb r0, [r1]
	movs r6, #3
	ands r6, r0
...
_080895E8: .4byte gSelectedLevel
...
_080896D2:
	...
	rsbs r0, r0, #0
	strb r0, [r1]
	ldr r0, _080897C0 @ =gSelectedLevel
	ldrb r1, [r0]
	movs r0, #3
	ands r0, r1
	cmp r0, #2
...
_080897C0: .4byte gSelectedLevel
...
_08089856:
	...
	cmp r1, #0x1c
	bls _08089886
	ldr r0, _08089914 @ =gSelectedLevel
	ldrb r1, [r0]
	movs r0, #3
	ands r0, r1
	movs r4, #3
...
_08089914: .4byte gSelectedLevel
...
sub_80899B8: @ 0x080899B8
	...
	ldrb r0, [r0]
	str r0, [sp, #0xc]
	ldr r1, _08089A88 @ =gSelectedLevel
	ldrb r0, [r1]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x1a
	lsls r0, r0, #0x18
...
_08089A88: .4byte gSelectedLevel
