...
.arm
	...
	thumb_func_start sub_80717EC_InitGameData
sub_80717EC_InitGameData: @ 0x080717EC
	push {r4, r5, lr}
	adds r4, r0, #0
	movs r2, #0xde
	lsls r2, r2, #2
...
_08071D12:
	...
	thumb_func_start sub_8071D24_WriteSave
sub_8071D24_WriteSave: @ 0x08071D24
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_08071E24: .4byte 0xFFFF7FFF
	...
	thumb_func_start sub_8071E28_ReadSaveToGameData
sub_8071E28_ReadSaveToGameData: @ 0x08071E28
	push {r4, r5, r6, r7, lr}
	mov r7, sb
	mov r6, r8
	push {r6, r7}
...
_08071E7C:
	...
	adds r0, r6, #0
	adds r1, r4, #0
	bl sub_8072538_ReadSaveAndVerifyChecksum
	lsls r0, r0, #0x10
	lsrs r1, r0, #0x10
	mov r8, r1
	cmp r0, #0
