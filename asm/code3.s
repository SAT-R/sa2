...
_080749C4:
	...
	b _08074A9E
	.align 2, 0
_080749F4: .4byte gSinLookup
_080749F8:
	adds r1, r2, #0
	adds r1, #0x64
	movs r0, #0xe
	strh r0, [r1]
	ldr r1, _08074A18 @ =gSinLookup
	movs r3, #0x80
	lsls r3, r3, #3
	adds r0, r1, r3
	ldrh r0, [r0]
...
_08079A32:
	...
	b _08079AB2
	.align 2, 0
_08079A60: .4byte gSinLookup
_08079A64: .4byte IWRAM_START + 0x4D
_08079A68:
	ldr r2, _08079A9C @ =gSinLookup
...
_0807C38C:
	...
	b _0807C3BE
	.align 2, 0
_0807C3A8: .4byte gSinLookup
_0807C3AC:
	ldr r1, _0807C3D4 @ =gSinLookup
	ldrb r0, [r2]
	lsls r0, r0, #3
	adds r0, r0, r1
	ldrh r0, [r0]
