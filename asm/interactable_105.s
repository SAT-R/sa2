...
initSprite_Interactable105: @ 0x08080920
	...
	lsrs r0, r0, #0x18
	mov r8, r0
	ldr r0, _080809AC @ =Task_Interactable105
	ldr r2, _080809B0 @ =0x00001FF0
	ldr r1, _080809B4 @ =TaskDestructor_Interactable105
	str r1, [sp]
	movs r1, #0x18
	movs r3, #0
	bl TaskCreate
	...
	bx r0
	.align 2, 0
_080809AC: .4byte Task_Interactable105
_080809B0: .4byte 0x00001FF0
_080809B4: .4byte TaskDestructor_Interactable105
...
_08080A4E:
	...
	thumb_func_start Task_Interactable105
Task_Interactable105: @ 0x08080A5C
	push {r4, lr}
...
_08080A94: .4byte gPlayer
	...
	thumb_func_start TaskDestructor_Interactable105
TaskDestructor_Interactable105: @ 0x08080A98
	bx lr
	.align 2, 0
