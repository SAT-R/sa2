...
.arm
	...
	thumb_func_start sub_8002A3C
sub_8002A3C: @ 0x08002A3C
	push {r4, r5, r6, lr}
	adds r3, r0, #0
	ldrh r0, [r3, #0x1c]
	ldr r1, _08002B00 @ =gUnknown_03002260
	ldr r1, [r1]
	lsls r0, r0, #2
	adds r0, r0, r1
	ldr r4, [r0]
	...
	cmp r0, #0
	bne _08002A84
	ldr r1, _08002B04 @ =gUnknown_030027A0
	ldr r2, _08002B08 @ =gUnknown_03002A84
	ldrb r0, [r2]
	lsls r0, r0, #2
	adds r0, r0, r1
	str r3, [r0]
...
_08002A84:
	...
	cmp r0, #0
	bne _08002AC8
	ldr r2, _08002B0C @ =0x040000D4
	str r6, [r2]
	mov r1, ip
	ldrb r0, [r1]
	lsls r0, r0, #1
	ldr r1, _08002B10 @ =gBgPalette
	adds r0, r0, r1
	str r0, [r2, #4]
	movs r0, #0x80
	lsls r0, r0, #0x18
	...
	str r5, [r2, #8]
	ldr r0, [r2, #8]
	ldr r2, _08002B14 @ =gUnknown_03001840
	ldr r0, [r2]
	movs r1, #1
	orrs r0, r1
	str r0, [r2]
...
_08002AC8:
	...
	strh r0, [r3, #0x3e]
_08002AE2:
	ldr r1, _08002B18 @ =gUnknown_03001800
	ldr r2, _08002B1C @ =gUnknown_0300287C
	ldrb r0, [r2]
	lsls r0, r0, #2
	adds r0, r0, r1
	str r3, [r0]
	...
	bx r0
	.align 2, 0
_08002B00: .4byte gUnknown_03002260
_08002B04: .4byte gUnknown_030027A0
_08002B08: .4byte gUnknown_03002A84
_08002B0C: .4byte 0x040000D4
_08002B10: .4byte gBgPalette
_08002B14: .4byte gUnknown_03001840
_08002B18: .4byte gUnknown_03001800
_08002B1C: .4byte gUnknown_0300287C
...
sub_8004314: @ 0x08004314
	...
	str r0, [r2, #8]
	ldr r0, [r2, #8]
	ldr r2, _0800437C @ =gUnknown_03001840
	ldr r0, [r2]
	movs r1, #1
	orrs r0, r1
	str r0, [r2]
...
_0800437C: .4byte gUnknown_03001840
...
_080059B2:
	...
	cmp r3, #0x1f
	ble _0800596A
	ldr r2, _08005A18 @ =gUnknown_03001840
	ldr r1, [r2]
	movs r0, #0x80
	lsls r0, r0, #4
	ands r0, r1
...
_08005A18: .4byte gUnknown_03001840
...
_08005AB0:
	...
	strb r0, [r2]
	ldr r1, _08005AE8 @ =gUnknown_03001840
	ldr r0, [r1]
	movs r1, #0x80
	lsls r1, r1, #7
	ands r0, r1
...
_08005AE8: .4byte gUnknown_03001840
