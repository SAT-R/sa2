...
_0806BAD6:
	...
	lsls r0, r0, #0x12
	adds r7, r2, r0
	ldr r1, _0806BB38 @ =IWRAM_START + 0x594
	adds r0, r2, r1
	movs r1, #0x80
	lsls r1, r1, #0x11
	str r1, [r0]
	ldr r3, _0806BB3C @ =IWRAM_START + 0x598
	adds r0, r2, r3
	str r1, [r0]
	ldr r0, _0806BB40 @ =IWRAM_START + 0x59C
	adds r1, r2, r0
	movs r0, #0
	str r0, [r1]
	adds r3, #8
	...
	cmp r0, #4
	bgt _0806BB48
	ldr r1, _0806BB44 @ =IWRAM_START + 0x5B6
	adds r0, r2, r1
	strb r4, [r0]
	adds r3, #0x17
	adds r1, r2, r3
...
_0806BB38: .4byte IWRAM_START + 0x594
_0806BB3C: .4byte IWRAM_START + 0x598
_0806BB40: .4byte IWRAM_START + 0x59C
_0806BB44: .4byte IWRAM_START + 0x5B6
_0806BB48:
	ldr r0, _0806BC78 @ =IWRAM_START + 0x5B6
	adds r1, r2, r0
	movs r0, #2
	strb r0, [r1]
	ldr r3, _0806BC7C @ =IWRAM_START + 0x5B7
	adds r1, r2, r3
	movs r0, #1
_0806BB56:
	strb r0, [r1]
...
_0806BC4A:
	...
	bx r0
	.align 2, 0
_0806BC78: .4byte IWRAM_START + 0x5B6
_0806BC7C: .4byte IWRAM_START + 0x5B7
...
sub_806BD28: @ 0x0806BD28
	...
	movs r0, #0xaf
	strh r0, [r2]
	ldr r0, _0806BD8C @ =IWRAM_START + 0x5A2
	adds r4, r4, r0
	ldrh r0, [r4]
	adds r0, #1
	strh r0, [r4]
...
_0806BD8C: .4byte IWRAM_START + 0x5A2
...
sub_806BD94: @ 0x0806BD94
	...
	lsls r0, r0, #0x12
	adds r4, r5, r0
	ldr r0, _0806BDC4 @ =IWRAM_START + 0x5B4
	adds r1, r5, r0
	movs r0, #2
	strh r0, [r1]
	ldr r3, _0806BDC8 @ =IWRAM_START + 0x5A2
	adds r0, r5, r3
	movs r3, #0
	ldrsh r0, [r0, r3]
	cmp r0, #1
...
_0806BDC4: .4byte IWRAM_START + 0x5B4
_0806BDC8: .4byte IWRAM_START + 0x5A2
_0806BDCC:
	cmp r0, #2
	beq _0806BE0E
	cmp r0, #3
...
_0806BDD6:
	...
	bl sub_806CF78
	str r0, [r4, #0xc]
	ldr r0, _0806BDFC @ =IWRAM_START + 0x5D4
	adds r1, r5, r0
	...
	b _0806BE2C
	.align 2, 0
_0806BDFC: .4byte IWRAM_START + 0x5D4
...
sub_806BE40: @ 0x0806BE40
	...
	ldrh r4, [r0, #6]
	bl sub_806C864
	ldr r1, _0806BE8C @ =IWRAM_START + 0x5BA
	adds r0, r4, r1
	ldrb r0, [r0]
	cmp r0, #0
	bne _0806BE64
	bl sub_806C7B8
	ldr r2, _0806BE90 @ =IWRAM_START + 0x5A2
	adds r1, r4, r2
	ldrh r0, [r1]
	adds r0, #1
	strh r0, [r1]
_0806BE64:
	ldr r0, _0806BE90 @ =IWRAM_START + 0x5A2
	adds r1, r4, r0
	movs r2, #0
	ldrsh r0, [r1, r2]
	cmp r0, #0x3b
	...
	movs r0, #0
	strh r0, [r1]
	ldr r0, _0806BE94 @ =IWRAM_START + 0x5B4
	adds r1, r4, r0
	movs r0, #5
	strh r0, [r1]
	ldr r1, [r5]
...
_0806BE8C: .4byte IWRAM_START + 0x5BA
_0806BE90: .4byte IWRAM_START + 0x5A2
_0806BE94: .4byte IWRAM_START + 0x5B4
...
sub_806BE9C: @ 0x0806BE9C
	...
	ldrh r4, [r0, #6]
	adds r6, r4, r1
	ldr r0, _0806BF0C @ =IWRAM_START + 0x5B4
	adds r2, r2, r0
	ldrh r0, [r2]
	cmp r0, #6
	bne _0806BED2
...
_0806BF0C: .4byte IWRAM_START + 0x5B4
...
_0806C0E2:
	...
	cmp r0, #0xd
	bne _0806C144
	ldr r2, _0806C13C @ =IWRAM_START + 0x5A2
	adds r0, r5, r2
	strh r4, [r0]
	movs r0, #0x10
	strh r0, [r1]
...
_0806C13C: .4byte IWRAM_START + 0x5A2
...
sub_806C158: @ 0x0806C158
	...
	bl sub_8070BF0
	str r0, [r6, #0x10]
	ldr r3, _0806C1EC @ =IWRAM_START + 0x5A8
	adds r2, r4, r3
	ldr r1, _0806C1F0 @ =IWRAM_START + 0x5A4
	adds r0, r4, r1
	movs r3, #0
	ldrsh r1, [r0, r3]
	movs r0, #0x64
	...
	str r1, [r2]
_0806C19E:
	ldr r0, _0806C1F8 @ =IWRAM_START + 0x5AC
	adds r2, r4, r0
	ldr r1, _0806C1FC @ =IWRAM_START + 0x5C5
	adds r3, r4, r1
	movs r0, #0
	ldrsb r0, [r3, r0]
	movs r1, #0
...
_0806C1B2:
	str r1, [r2]
	ldr r1, _0806C204 @ =IWRAM_START + 0x5B0
	adds r0, r4, r1
	str r5, [r0]
	...
	movs r0, #0x38
	bl m4aSongNumStart
	ldr r3, _0806C20C @ =IWRAM_START + 0x5C7
	adds r1, r4, r3
	movs r0, #1
	strb r0, [r1]
	ldr r0, _0806C210 @ =IWRAM_START + 0x5C8
	adds r1, r4, r0
	movs r0, #0x96
	strb r0, [r1]
	b _0806C236
...
_0806C1EC: .4byte IWRAM_START + 0x5A8
_0806C1F0: .4byte IWRAM_START + 0x5A4
_0806C1F4: .4byte 0x0001863C
_0806C1F8: .4byte IWRAM_START + 0x5AC
_0806C1FC: .4byte IWRAM_START + 0x5C5
_0806C200: .4byte 0x00002710
_0806C204: .4byte IWRAM_START + 0x5B0
_0806C208: .4byte IWRAM_START + 0xB4
_0806C20C: .4byte IWRAM_START + 0x5C7
_0806C210: .4byte IWRAM_START + 0x5C8
_0806C214:
	movs r0, #0x37
	bl m4aSongNumStart
	ldr r1, _0806C22C @ =IWRAM_START + 0x5C7
	adds r0, r4, r1
	mov r3, r8
	strb r3, [r0]
	adds r1, #1
	...
	b _0806C236
	.align 2, 0
_0806C22C: .4byte IWRAM_START + 0x5C7
_0806C230:
	movs r0, #0x39
	bl m4aSongNumStart
_0806C236:
...
sub_806C25C: @ 0x0806C25C
	...
	lsls r0, r0, #0x12
	adds r5, r1, r0
	ldr r0, _0806C2A8 @ =IWRAM_START + 0x5C7
	adds r6, r1, r0
	movs r0, #0
	ldrsb r0, [r6, r0]
	cmp r0, #1
	bne _0806C290
	ldr r0, _0806C2AC @ =IWRAM_START + 0x5C8
	adds r1, r1, r0
	ldrb r0, [r1]
	subs r0, #1
	strb r0, [r1]
...
_0806C2A8: .4byte IWRAM_START + 0x5C7
_0806C2AC: .4byte IWRAM_START + 0x5C8
...
sub_806C338: @ 0x0806C338
	...
	lsls r0, r0, #0x12
	adds r7, r1, r0
	ldr r0, _0806C384 @ =IWRAM_START + 0x5C7
	adds r5, r1, r0
	movs r0, #0
	ldrsb r0, [r5, r0]
	cmp r0, #1
	bne _0806C36C
	ldr r0, _0806C388 @ =IWRAM_START + 0x5C8
	adds r1, r1, r0
	ldrb r0, [r1]
	subs r0, #1
	strb r0, [r1]
...
_0806C384: .4byte IWRAM_START + 0x5C7
_0806C388: .4byte IWRAM_START + 0x5C8
...
sub_806C42C: @ 0x0806C42C
	...
	ldr r0, [r6]
	ldrh r4, [r0, #6]
	ldr r0, _0806C484 @ =IWRAM_START + 0x5B0
	adds r3, r4, r0
	ldr r1, _0806C488 @ =IWRAM_START + 0x5A8
	adds r2, r4, r1
	ldr r0, [r3]
	ldr r1, [r2]
	adds r0, r0, r1
	...
	movs r5, #0
	str r5, [r2]
	ldr r0, _0806C48C @ =IWRAM_START + 0x5AC
	adds r2, r4, r0
	ldr r0, [r3]
	ldr r1, [r2]
	adds r0, r0, r1
...
_0806C460:
	...
	bl m4aSongNumStart
_0806C46C:
	ldr r1, _0806C494 @ =IWRAM_START + 0x5A2
	adds r0, r4, r1
	strh r5, [r0]
	ldr r1, [r6]
...
_0806C484: .4byte IWRAM_START + 0x5B0
_0806C488: .4byte IWRAM_START + 0x5A8
_0806C48C: .4byte IWRAM_START + 0x5AC
_0806C490: .4byte 0x0001863C
_0806C494: .4byte IWRAM_START + 0x5A2
...
sub_806C49C: @ 0x0806C49C
	...
	adds r0, #0x88
	adds r4, r2, r0
	ldr r0, _0806C52C @ =IWRAM_START + 0x5A2
	adds r1, r2, r0
	ldrh r0, [r1]
	adds r0, #1
	strh r0, [r1]
	ldr r1, _0806C530 @ =IWRAM_START + 0x5C7
	adds r5, r2, r1
	movs r0, #0
	ldrsb r0, [r5, r0]
	cmp r0, #1
	bne _0806C4DE
	ldr r0, _0806C534 @ =IWRAM_START + 0x5C8
	adds r1, r2, r0
	ldrb r0, [r1]
	subs r0, #1
	strb r0, [r1]
...
_0806C52C: .4byte IWRAM_START + 0x5A2
_0806C530: .4byte IWRAM_START + 0x5C7
_0806C534: .4byte IWRAM_START + 0x5C8
...
sub_806C560: @ 0x0806C560
	...
	lsls r0, r0, #0x12
	adds r6, r1, r0
	ldr r2, _0806C5E4 @ =IWRAM_START + 0x5B6
	adds r0, r1, r2
	ldrb r0, [r0]
	mov r8, r0
	...
	add r0, r8
	ldrb r5, [r0]
	ldr r0, _0806C5EC @ =IWRAM_START + 0x5C7
	adds r7, r1, r0
	movs r0, #0
	ldrsb r0, [r7, r0]
	cmp r0, #1
...
_0806C5E4: .4byte IWRAM_START + 0x5B6
_0806C5E8: .4byte gLoadedSaveGame
_0806C5EC: .4byte IWRAM_START + 0x5C7
...
sub_806C638: @ 0x0806C638
	...
	lsls r0, r0, #0x12
	adds r6, r1, r0
	ldr r0, _0806C694 @ =IWRAM_START + 0x5C7
	adds r5, r1, r0
	movs r0, #0
	ldrsb r0, [r5, r0]
	cmp r0, #1
	bne _0806C66C
	ldr r0, _0806C698 @ =IWRAM_START + 0x5C8
	adds r1, r1, r0
	ldrb r0, [r1]
	subs r0, #1
	strb r0, [r1]
...
_0806C694: .4byte IWRAM_START + 0x5C7
_0806C698: .4byte IWRAM_START + 0x5C8
...
sub_806C6A4: @ 0x0806C6A4
	...
	cmp r0, #0
	beq _0806C770
	ldr r2, _0806C780 @ =IWRAM_START + 0x5A2
	adds r1, r4, r2
	ldrh r0, [r1]
	adds r0, #1
	movs r5, #0
	...
	cmp r0, #0x77
	ble _0806C770
	ldr r3, _0806C784 @ =IWRAM_START + 0x5B0
	adds r0, r4, r3
	ldr r4, [r0]
	ldr r0, [r7, #0xc]
	cmp r0, #0
...
_0806C780: .4byte IWRAM_START + 0x5A2
_0806C784: .4byte IWRAM_START + 0x5B0
...
sub_806C7B8: @ 0x0806C7B8
	...
	lsls r0, r0, #0x12
	adds r7, r1, r0
	ldr r0, _0806C7E0 @ =IWRAM_START + 0x5BE
	adds r6, r1, r0
	ldrb r2, [r6]
	movs r0, #0
	ldrsb r0, [r6, r0]
...
_0806C7E0: .4byte IWRAM_START + 0x5BE
_0806C7E4:
	ldr r0, _0806C7F8 @ =IWRAM_START + 0x5BD
	adds r4, r1, r0
	ldrb r2, [r4]
	movs r0, #0
	ldrsb r0, [r4, r0]
	...
	b _0806C850
	.align 2, 0
_0806C7F8: .4byte IWRAM_START + 0x5BD
_0806C7FC:
	ldr r0, _0806C814 @ =IWRAM_START + 0x5BC
	adds r3, r1, r0
	ldrb r2, [r3]
	movs r0, #0
	ldrsb r0, [r3, r0]
	...
	b _0806C850
	.align 2, 0
_0806C814: .4byte IWRAM_START + 0x5BC
_0806C818:
	ldr r0, _0806C840 @ =IWRAM_START + 0x5BB
	adds r2, r1, r0
	ldrb r5, [r2]
	movs r0, #0
	ldrsb r0, [r2, r0]
	...
	strb r0, [r4]
	strb r0, [r6]
	ldr r0, _0806C844 @ =IWRAM_START + 0x5B4
	adds r1, r1, r0
	ldrh r0, [r1]
	cmp r0, #7
	beq _0806C85A
	...
	b _0806C85A
	.align 2, 0
_0806C840: .4byte IWRAM_START + 0x5BB
_0806C844: .4byte IWRAM_START + 0x5B4
_0806C848:
	subs r0, r5, #1
	strb r0, [r2]
	movs r0, #9
...
sub_806C864: @ 0x0806C864
	...
	lsls r0, r0, #0x12
	adds r7, r2, r0
	ldr r0, _0806C8B8 @ =IWRAM_START + 0x5BA
	adds r6, r2, r0
	ldrb r3, [r6]
...
_0806C8B8: .4byte IWRAM_START + 0x5BA
_0806C8BC: .4byte gPressedKeys
_0806C8C0:
	ands r3, r1
	cmp r3, #0
	beq _0806C920
	ldr r1, _0806C8DC @ =IWRAM_START + 0x5C6
	adds r0, r2, r1
	ldrb r0, [r0]
	cmp r0, #0
	bne _0806C8E4
	...
	b _0806C942
	.align 2, 0
_0806C8DC: .4byte IWRAM_START + 0x5C6
...
sub_806C970: @ 0x0806C970
	...
	movs r2, #0x28
	bl sub_806CA88
	ldr r0, _0806C9C4 @ =IWRAM_START + 0x5B4
	adds r4, r4, r0
	movs r0, #1
	strh r0, [r4]
	movs r0, #0x32
...
_0806C9C4: .4byte IWRAM_START + 0x5B4
...
sub_806C9CC: @ 0x0806C9CC
	...
	cmp r0, #0
	beq _0806C9FE
	ldr r0, _0806CA0C @ =IWRAM_START + 0x5A2
	adds r1, r4, r0
	movs r0, #0
	strh r0, [r1]
	ldr r0, _0806CA10 @ =IWRAM_START + 0x5B4
	adds r1, r4, r0
	movs r0, #4
	strh r0, [r1]
	movs r0, #0x33
...
_0806CA0C: .4byte IWRAM_START + 0x5A2
_0806CA10: .4byte IWRAM_START + 0x5B4
...
sub_806CA18: @ 0x0806CA18
	...
	strh r0, [r1]
	strh r0, [r1, #2]
	ldr r0, _0806CA4C @ =IWRAM_START + 0x5A2
	adds r2, r2, r0
	ldrh r0, [r2]
	adds r0, #1
	strh r0, [r2]
...
_0806CA4C: .4byte IWRAM_START + 0x5A2
...
sub_806CA54: @ 0x0806CA54
	...
	ldr r2, [r0]
	ldrh r0, [r2, #6]
	ldr r3, _0806CA80 @ =IWRAM_START + 0x5A2
	adds r1, r0, r3
	ldrh r0, [r1]
	adds r0, #1
	strh r0, [r1]
...
_0806CA80: .4byte IWRAM_START + 0x5A2
