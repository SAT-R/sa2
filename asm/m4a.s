...
m4aSoundInit: @ 0x080952A8
	push {r4, r5, r6, lr}
	ldr r0, _080952FC @ =sub_809467C+1
	movs r1, #2
	rsbs r1, r1, #0
	ands r0, r1
	ldr r1, _08095300 @ =gUnknown_03000000
	ldr r2, _08095304 @ =0x04000100
	bl CpuSet
	ldr r0, _08095308 @ =gUnknown_02001400
	bl sub_80956A8
	ldr r0, _0809530C @ =gUnknown_02002440
	bl sub_8095564
	ldr r0, _08095310 @ =0x0093F500
	bl m4aSoundMode
	ldr r0, _08095314 @ =0x00000004
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	cmp r0, #0
	beq _080952F6
	ldr r5, _08095318 @ =gMPlayTable
	adds r6, r0, #0
_080952DA:
	ldr r4, [r5]
	ldr r1, [r5, #4]
	...
	ldrh r0, [r5, #0xa]
	strb r0, [r4, #0xb]
	ldr r0, _0809531C @ =gUnknown_02002600
	str r0, [r4, #0x18]
	adds r5, #0xc
	subs r6, #1
	cmp r6, #0
...
_080952F6:
	...
	bx r0
	.align 2, 0
_080952FC: .4byte sub_809467C+1
_08095300: .4byte gUnknown_03000000
_08095304: .4byte 0x04000100
_08095308: .4byte gUnknown_02001400
_0809530C: .4byte gUnknown_02002440
_08095310: .4byte 0x0093F500
_08095314: .4byte 0x00000004
_08095318: .4byte gMPlayTable
_0809531C: .4byte gUnknown_02002600
...
_0809555E:
	...
	thumb_func_start sub_8095564
sub_8095564: @ 0x08095564
	push {r4, r5, r6, lr}
	sub sp, #4
	adds r5, r0, #0
...
_080959E4: .4byte 0x040000C6
	...
	thumb_func_start sub_80959E8
sub_80959E8: @ 0x080959E8
	push {r4, r5, r6, r7, lr}
	adds r7, r0, #0
	adds r6, r1, #0
	lsls r2, r2, #0x18
