...
Task_Interactable_Decoration: @ 0x0805D794
	...
	movs r0, #0xc0
	lsls r0, r0, #0x12
	adds r5, r1, r0     @ R5 = decoBase
	adds r0, #0xc
	adds r6, r1, r0     @ R6 = deco
	ldr r7, [r5]        @ R7 = entity
	ldrb r1, [r5, #8]
	lsls r1, r1, #3
	ldrh r0, [r5, #4]
	lsls r0, r0, #8
	adds r1, r1, r0     @ R1 = mapX
	ldrb r2, [r7, #1]
	lsls r2, r2, #3
	ldrh r0, [r5, #6]
	lsls r0, r0, #8
	adds r2, r2, r0     @ R2 = mapY
	ldr r3, _0805D7FC @ =gCamera
	ldr r0, [r3]
	subs r1, r1, r0
	strh r1, [r6, #0x16]
	ldr r0, [r3, #4]
