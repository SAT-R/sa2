...
sub_808BB54: @ 0x0808BB54
	...
	adds r0, r4, r0
	bl sub_808CBA4
	ldr r0, _0808BBD8 @ =IWRAM_START + 0xF3E
	adds r5, r4, r0
	ldrh r0, [r5]
	cmp r0, #1
	bne _0808BBA8
	ldr r1, _0808BBDC @ =IWRAM_START + 0x80
	adds r0, r4, r1
	...
	movs r1, #0x14
	strh r1, [r0, #0x28]
	ldr r2, _0808BBE8 @ =IWRAM_START + 0xAA
	adds r1, r4, r2
	strb r3, [r1]
	movs r1, #0x10
	strh r1, [r0, #0x2e]
...
_0808BBD8: .4byte IWRAM_START + 0xF3E
_0808BBDC: .4byte IWRAM_START + 0x80
_0808BBE0: .4byte 0x06004000
_0808BBE4: .4byte 0x0600F800
_0808BBE8: .4byte IWRAM_START + 0xAA
...
sub_808BBF4: @ 0x0808BBF4
	...
	ldr r0, _0808BC48 @ =IWRAM_START + 0xF3E
	adds r4, r4, r0
	ldrh r1, [r4]
	movs r0, #0x10
	subs r0, r0, r1
...
_0808BC48: .4byte IWRAM_START + 0xF3E
...
sub_808BC54: @ 0x0808BC54
	...
	ldr r0, _0808BCB0 @ =IWRAM_START + 0xF3E
	adds r4, r4, r0
	ldrh r1, [r4]
	lsls r2, r1, #1
	lsls r1, r1, #9
...
_0808BCB0: .4byte IWRAM_START + 0xF3E
...
_0808BCF8:
	ldr r0, _0808BD90 @ =IWRAM_START + 0xF3E
	adds r5, r6, r0
	ldrh r0, [r5]
	cmp r0, #0x3b
	bne _0808BD38
	ldr r1, _0808BD94 @ =IWRAM_START + 0x40
	adds r0, r6, r1
	...
	movs r1, #0x40
	strh r1, [r0, #0x28]
	ldr r3, _0808BDA4 @ =IWRAM_START + 0x6A
	adds r1, r6, r3
	strb r2, [r1]
	movs r1, #1
	strh r1, [r0, #0x2e]
...
_0808BD86:
	...
	bx r0
	.align 2, 0
_0808BD90: .4byte IWRAM_START + 0xF3E
_0808BD94: .4byte IWRAM_START + 0x40
_0808BD98: .4byte 0x06008000
_0808BD9C: .4byte 0x0600E800
_0808BDA0: .4byte 0x00000105
_0808BDA4: .4byte IWRAM_START + 0x6A
...
_0808BFAC:
	ldr r0, _0808C050 @ =IWRAM_START + 0xF3E
	adds r0, r0, r6
	mov r8, r0
	ldrh r0, [r0]
	cmp r0, #2
...
_0808BFEC:
	...
	b _0808C072
	.align 2, 0
_0808C050: .4byte IWRAM_START + 0xF3E
...
_0808C084:
	...
	strh r2, [r7, #0x18]
	strh r2, [r7, #0x1a]
	ldr r0, _0808C100 @ =gLoadedSaveGame
	ldr r0, [r0]
	ldrb r0, [r0, #6]
	cmp r0, #1
	bhi _0808C104
...
_0808C100: .4byte gLoadedSaveGame
_0808C104:
...
_0808C1D8:
	...
	ldr r0, _0808C210 @ =IWRAM_START + 0xF3E
	adds r2, r1, r0
	ldrh r0, [r2]
	lsrs r0, r0, #2
	movs r1, #0x10
...
_0808C210: .4byte IWRAM_START + 0xF3E
...
sub_808C218: @ 0x0808C218
	...
	adds r0, r0, r5
	mov r8, r0
	ldr r0, _0808C2A8 @ =IWRAM_START + 0xF3E
	adds r4, r5, r0
	ldrh r0, [r4]
	cmp r0, #0x27
	bhi _0808C23E
	ldr r1, _0808C2AC @ =IWRAM_START + 0xF0
	adds r0, r5, r1
	bl sub_80051E8
_0808C23E:
	ldrh r0, [r4]
	...
	strh r6, [r4]
_0808C250:
	ldr r1, _0808C2B0 @ =IWRAM_START + 0xC0
	adds r0, r5, r1
	bl sub_80051E8
...
_0808C2A8: .4byte IWRAM_START + 0xF3E
_0808C2AC: .4byte IWRAM_START + 0xF0
_0808C2B0: .4byte IWRAM_START + 0xC0
...
sub_808C2C8: @ 0x0808C2C8
	...
	lsls r0, r0, #0x12
	adds r6, r4, r0
	ldr r0, _0808C33C @ =IWRAM_START + 0xF3E
	adds r5, r4, r0
	ldrh r1, [r5]
	movs r0, #7
	ands r0, r1
	cmp r0, #3
	bls _0808C2EC
	ldr r1, _0808C340 @ =IWRAM_START + 0xF0
	adds r0, r4, r1
	bl sub_80051E8
_0808C2EC:
	ldrh r0, [r5]
	adds r0, #1
	strh r0, [r5]
	ldr r1, _0808C344 @ =IWRAM_START + 0xC0
	adds r0, r4, r1
	bl sub_80051E8
	ldrh r0, [r5]
	cmp r0, #0xa
	bne _0808C314
	ldr r1, _0808C348 @ =IWRAM_START + 0x120
	adds r0, r4, r1
	movs r1, #1
	bl sub_808D790
	ldr r1, _0808C34C @ =IWRAM_START + 0x150
	adds r0, r4, r1
	movs r1, #1
	bl sub_808D790
_0808C314:
...
_0808C33C: .4byte IWRAM_START + 0xF3E
_0808C340: .4byte IWRAM_START + 0xF0
_0808C344: .4byte IWRAM_START + 0xC0
_0808C348: .4byte IWRAM_START + 0x120
_0808C34C: .4byte IWRAM_START + 0x150
...
sub_808C498: @ 0x0808C498
	...
	lsls r0, r0, #0x12
	adds r6, r4, r0
	ldr r0, _0808C554 @ =IWRAM_START + 0x120
	adds r2, r4, r0
	ldr r1, _0808C558 @ =IWRAM_START + 0xF3E
	adds r5, r4, r1
	ldrh r1, [r5]
	movs r0, #7
	ands r0, r1
...
_0808C4BE:
	...
	adds r0, #1
	strh r0, [r5]
	ldr r2, _0808C55C @ =IWRAM_START + 0xC0
	adds r0, r4, r2
	bl sub_80051E8
...
_0808C4EC:
	...
	cmp r0, #8
	bne _0808C524
	ldr r1, _0808C56C @ =IWRAM_START + 0x180
	adds r0, r4, r1
	movs r1, #1
	bl sub_808D790
	ldr r2, _0808C570 @ =IWRAM_START + 0x1B0
	adds r0, r4, r2
	movs r1, #1
	bl sub_808D790
	ldr r1, _0808C574 @ =IWRAM_START + 0x1E0
	adds r0, r4, r1
	movs r1, #1
	bl sub_808D790
	ldr r0, _0808C578 @ =gLoadedSaveGame
	ldr r0, [r0]
	ldrb r0, [r0, #0x14]
	cmp r0, #0
	beq _0808C524
	ldr r2, _0808C57C @ =IWRAM_START + 0x210
	adds r0, r4, r2
	movs r1, #1
	bl sub_808D790
_0808C524:
...
_0808C554: .4byte IWRAM_START + 0x120
_0808C558: .4byte IWRAM_START + 0xF3E
_0808C55C: .4byte IWRAM_START + 0xC0
_0808C560: .4byte gPressedKeys
_0808C564: .4byte gUnknown_03000F42
_0808C568: .4byte sub_808C358
_0808C56C: .4byte IWRAM_START + 0x180
_0808C570: .4byte IWRAM_START + 0x1B0
_0808C574: .4byte IWRAM_START + 0x1E0
_0808C578: .4byte gLoadedSaveGame
_0808C57C: .4byte IWRAM_START + 0x210
...
sub_808C58C: @ 0x0808C58C
	push {r4, r5, r6, lr}
	movs r6, #3
	ldr r0, _0808C5D0 @ =gLoadedSaveGame
	ldr r0, [r0]
	ldrb r0, [r0, #0x14]
	cmp r0, #0
	beq _0808C59C
...
_0808C5AE:
	...
	b _0808C5E2
	.align 2, 0
_0808C5D0: .4byte gLoadedSaveGame
...
sub_808C710: @ 0x0808C710
	...
	lsls r0, r0, #0x12
	adds r6, r4, r0
	ldr r1, _0808C758 @ =IWRAM_START + 0x270
	adds r0, r4, r1
	bl sub_802D4CC
	lsls r0, r0, #0x18
	lsrs r0, r0, #0x18
...
_0808C758: .4byte IWRAM_START + 0x270
...
_0808C784:
	...
	strb r0, [r1]
	bl sub_801A6D8
	ldr r0, _0808C7AC @ =gLoadedSaveGame
	ldr r0, [r0]
	ldrb r1, [r0, #0x13]
	movs r0, #0x10
	ands r0, r1
...
_0808C7AC: .4byte gLoadedSaveGame
_0808C7B0:
	movs r0, #0
	movs r1, #0
	bl sub_803143C
...
_0808C7FA:
	...
	strb r0, [r1]
	bl sub_801A6D8
	ldr r0, _0808C81C @ =gLoadedSaveGame
	ldr r0, [r0]
	ldrh r1, [r0, #0x20]
...
_0808C81C: .4byte gLoadedSaveGame
...
_0808C838:
	...
	bne _0808C8A8
	movs r5, #0
	ldr r0, _0808C89C @ =IWRAM_START + 0xC0
	adds r7, r4, r0
	ldr r1, _0808C8A0 @ =IWRAM_START + 0xF3E
	adds r4, r4, r1
_0808C852:
	movs r0, #1
	adds r1, r5, #0
...
_0808C89C: .4byte IWRAM_START + 0xC0
_0808C8A0: .4byte IWRAM_START + 0xF3E
...
_0808C8A8:
	...
	movs r0, #1
	strb r0, [r1]
	ldr r3, _0808C8E4 @ =IWRAM_START + 0xF3E
	adds r1, r4, r3
	ldrh r0, [r1]
	adds r0, #1
	strh r0, [r1]
...
_0808C8DE:
	...
	bx r0
	.align 2, 0
_0808C8E4: .4byte IWRAM_START + 0xF3E
...
sub_808C8EC: @ 0x0808C8EC
	...
	strh r2, [r7, #0x18]
	strh r2, [r7, #0x1a]
	ldr r0, _0808C968 @ =gLoadedSaveGame
	ldr r0, [r0]
	ldrb r0, [r0, #6]
	cmp r0, #1
	bhi _0808C96C
...
_0808C968: .4byte gLoadedSaveGame
_0808C96C:
...
sub_808CAFC: @ 0x0808CAFC
	push {r4, r5, r6, lr}
	movs r6, #3
	ldr r0, _0808CB40 @ =gLoadedSaveGame
	ldr r0, [r0]
	ldrb r0, [r0, #0x14]
	cmp r0, #0
	beq _0808CB0C
...
_0808CB1E:
	...
	b _0808CB52
	.align 2, 0
_0808CB40: .4byte gLoadedSaveGame
...
sub_808CE00: @ 0x0808CE00
	...
	strh r0, [r4, #0xa]
	ldr r1, _0808CEE0 @ =IWRAM_START + 0x20
	adds r0, r5, r1
	strb r2, [r0]
	ldr r0, _0808CEE4 @ =IWRAM_START + 0x21
	adds r1, r5, r0
	movs r0, #0xff
	strb r0, [r1]
	strh r6, [r4, #0x16]
	...
	mov r1, sb
	strh r1, [r4, #0x1c]
	ldr r0, _0808CEE8 @ =IWRAM_START + 0x22
	adds r1, r5, r0
	movs r0, #0x10
	strb r0, [r1]
	ldr r1, _0808CEEC @ =IWRAM_START + 0x25
	adds r0, r5, r1
	strb r2, [r0]
	mov r0, sb
	str r0, [r4, #0x10]
	...
	strh r0, [r4, #0x34]
	strh r7, [r4, #0x36]
	ldr r1, _0808CEF4 @ =IWRAM_START + 0x3C
	adds r0, r5, r1
	ldr r2, [sp, #8]
	strb r2, [r0]
	adds r1, #1
	adds r0, r5, r1
	strb r2, [r0]
	ldr r0, _0808CEF8 @ =IWRAM_START + 0x3E
	adds r5, r5, r0
	mov r1, sp
	ldrb r1, [r1, #4]
	strb r1, [r5]
...
_0808CEE0: .4byte IWRAM_START + 0x20
_0808CEE4: .4byte IWRAM_START + 0x21
_0808CEE8: .4byte IWRAM_START + 0x22
_0808CEEC: .4byte IWRAM_START + 0x25
_0808CEF0: .4byte gBgScrollRegs
_0808CEF4: .4byte IWRAM_START + 0x3C
_0808CEF8: .4byte IWRAM_START + 0x3E
...
sub_808CEFC: @ 0x0808CEFC
	...
	adds r4, r2, r0
	adds r5, r4, #0
	ldr r1, _0808CF20 @ =IWRAM_START + 0x3C
	adds r0, r2, r1
	ldrb r0, [r0]
	cmp r0, #0
	beq _0808CF24
...
_0808CF20: .4byte IWRAM_START + 0x3C
_0808CF24:
	ldrh r0, [r4, #0x3a]
	adds r0, #0x30
	b _0808CF40
_0808CF2A:
	...
	ldr r3, _0808CF70 @ =IWRAM_START + 0x3D
	adds r0, r2, r3
	ldrb r0, [r0]
	lsls r0, r0, #5
	adds r0, r0, r1
...
_0808CF70: .4byte IWRAM_START + 0x3D
...
sub_808D124: @ 0x0808D124
	...
	movs r0, #0
	mov sb, r0
	ldr r4, _0808D220 @ =IWRAM_START + 0x180
	adds r6, r1, r4
	ldr r0, _0808D224 @ =IWRAM_START + 0x8
	adds r5, r1, r0
...
_0808D220: .4byte IWRAM_START + 0x180
_0808D224: .4byte IWRAM_START + 0x8
...
sub_808D23C: @ 0x0808D23C
	...
	lsls r0, r0, #0x12
	adds r7, r2, r0
	ldr r0, _0808D338 @ =IWRAM_START + 0x202
	adds r1, r2, r0
	ldrh r0, [r1]
	adds r0, #3
	strh r0, [r1]
	...
	strh r0, [r1, #2]
	ldr r1, _0808D34C @ =IWRAM_START + 0x205
	adds r0, r2, r1
	ldrb r1, [r0]
	movs r0, #1
	ands r0, r1
	...
	movs r3, #0
	mov sb, r3
	ldr r0, _0808D34C @ =IWRAM_START + 0x205
	adds r0, r0, r2
	mov sl, r0
	ldr r1, _0808D350 @ =IWRAM_START + 0x186
	adds r6, r2, r1
	ldr r3, _0808D354 @ =IWRAM_START + 0x180
	adds r3, r3, r2
	mov r8, r3
	adds r5, r7, #0
_0808D294:
...
sub_808D35C: @ 0x0808D35C
	...
	mov pc, r0
	.align 2, 0
_0808D37C: .4byte gLoadedSaveGame
...
sub_808D53C: @ 0x0808D53C
	...
	lsls r4, r4, #0x12
	adds r4, r5, r4
	ldr r1, _0808D588 @ =IWRAM_START + 0xC0
	adds r0, r5, r1
	bl sub_80051E8
	adds r0, r4, #0
	bl sub_808D740
	ldr r1, _0808D58C @ =IWRAM_START + 0x270
	adds r0, r5, r1
	bl sub_802D4CC
	lsls r0, r0, #0x18
	lsrs r0, r0, #0x18
	...
	movs r0, #0xc9
	bl m4aSongNumStart
	ldr r0, _0808D590 @ =IWRAM_START + 0xF3E
	adds r1, r5, r0
	movs r0, #0
	strh r0, [r1]
	ldr r1, [r6]
...
_0808D588: .4byte IWRAM_START + 0xC0
_0808D58C: .4byte IWRAM_START + 0x270
_0808D590: .4byte IWRAM_START + 0xF3E
...
sub_808D598: @ 0x0808D598
	...
	adds r0, r4, r0
	bl sub_808CBA4
	ldr r0, _0808D5E8 @ =IWRAM_START + 0x270
	adds r4, r4, r0
	adds r0, r4, #0
	bl sub_802D4CC
	lsls r0, r0, #0x18
...
sub_808D5FC: @ 0x0808D5FC
	...
	adds r0, r4, r0
	bl sub_808CBA4
	ldr r0, _0808D634 @ =IWRAM_START + 0xF3E
	adds r4, r4, r0
	ldrh r0, [r4]
	cmp r0, #0x78
	bls _0808D622
...
sub_808D63C: @ 0x0808D63C
	...
	adds r0, r4, r0
	bl sub_808CBA4
	ldr r0, _0808D674 @ =IWRAM_START + 0xF3E
	adds r4, r4, r0
	ldrh r0, [r4]
	cmp r0, #0x78
	bls _0808D662
...
_0808D674: .4byte IWRAM_START + 0xF3E
...
sub_808D67C: @ 0x0808D67C
	...
	lsls r0, r0, #0x12
	adds r5, r1, r0
	ldr r0, _0808D6C8 @ =IWRAM_START + 0xF3E
	adds r4, r1, r0
	ldrh r0, [r4]
	cmp r0, #0x3c
	bls _0808D6B0
...
_0808D6C8: .4byte IWRAM_START + 0xF3E
