...
sub_80075D0: @ 0x080075D0
	...
	cmp r0, #0
	beq _08007634
	ldr r0, _08007630 @ =gBgOffsetsHBlank
	ldr r0, [r0]
	adds r4, r0, #2
	b _0800766C
	.align 2, 0
...
_08007630: .4byte gBgOffsetsHBlank
_08007634:
	ldr r0, _0800763C @ =gBgOffsetsHBlank
	ldr r4, [r0]
	b _0800766C
	.align 2, 0
_0800763C: .4byte gBgOffsetsHBlank
_08007640:
	ldr r1, _0800765C @ =gUnknown_03002A80
	movs r0, #2
	strb r0, [r1]
	ldr r0, _08007660 @ =gBgOffsetsHBlank
	ldr r4, [r0]
	movs r0, #1
	ands r0, r7
	adds r2, r1, #0
...
_08007660: .4byte gBgOffsetsHBlank
...
sub_8007738: @ 0x08007738
	...
	strb r3, [r0]
	ldr r0, _08007848 @ =gBgOffsetsHBlank
	lsls r1, r7, #2
	ldr r0, [r0]
	adds r1, r0, r1
	ldr r0, [sp]
...
_08007848: .4byte gBgOffsetsHBlank
...
sub_8007858: @ 0x08007858
	...
	strb r3, [r0]
	ldr r0, _080078CC @ =gBgOffsetsHBlank
	lsls r1, r5, #2
	ldr r0, [r0]
	adds r2, r0, r1
	subs r4, r4, r5
...
sub_80078D4: @ 0x080078D4
	...
	mov r0, sp
	str r0, [r2]
	ldr r0, _08007954 @ =gBgOffsetsHBlank
	lsls r1, r5, #2
	ldr r0, [r0]
	adds r0, r0, r1
	str r0, [r2, #4]
