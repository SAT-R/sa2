...
_08005D08:
	...
	mov sl, r0
	lsls r1, r3, #2
	ldr r7, _08005E28 @ =gComputedBgBuffer
	ldr r0, [r7]
	adds r4, r0, r1
	mov r0, ip
	subs r5, r0, r3
...
_08005D7C:
	...
	adds r3, r0, #0
	lsls r1, r0, #2
	ldr r4, _08005E28 @ =gComputedBgBuffer
	ldr r0, [r4]
	adds r4, r0, r1
	ldr r0, [sp, #4]
	subs r5, r0, r3
...
_08005DE4:
	...
	strb r1, [r0]
	ldr r1, _08005E28 @ =gComputedBgBuffer
	ldr r0, [r1]
	mov r2, sb
	adds r4, r0, r2
	mov r3, r8
	...
	b _08005E44
	.align 2, 0
_08005E28: .4byte gComputedBgBuffer
...
sub_8005FB4: @ 0x08005FB4
	...
	cmp r0, #0
	beq _08006004
	ldr r0, _08006000 @ =gComputedBgBuffer
	ldr r0, [r0]
	adds r3, r0, #2
	b _08006038
	.align 2, 0
...
_08006000: .4byte gComputedBgBuffer
_08006004:
	ldr r0, _0800600C @ =gComputedBgBuffer
	ldr r3, [r0]
	b _08006038
	.align 2, 0
_0800600C: .4byte gComputedBgBuffer
_08006010:
	ldr r1, _08006028 @ =gUnknown_03002A80
	movs r0, #2
	strb r0, [r1]
	ldr r0, _0800602C @ =gComputedBgBuffer
	ldr r3, [r0]
	movs r0, #1
	ands r0, r6
	cmp r0, #0
...
_0800602C: .4byte gComputedBgBuffer
...
sub_8006228: @ 0x08006228
	...
	cmp r0, #0
	beq _08006284
	ldr r0, _08006280 @ =gComputedBgBuffer
	ldr r0, [r0]
	adds r3, r0, #2
	b _080062B8
	.align 2, 0
...
_08006280: .4byte gComputedBgBuffer
_08006284:
	ldr r0, _0800628C @ =gComputedBgBuffer
	ldr r3, [r0]
	b _080062B8
	.align 2, 0
_0800628C: .4byte gComputedBgBuffer
_08006290:
	ldr r1, _080062A8 @ =gUnknown_03002A80
	movs r0, #2
	strb r0, [r1]
	ldr r0, _080062AC @ =gComputedBgBuffer
	ldr r3, [r0]
	movs r0, #1
	ands r0, r7
	cmp r0, #0
...
_080062AC: .4byte gComputedBgBuffer
...
sub_80064A8: @ 0x080064A8
	...
	cmp r0, #0
	beq _08006504
	ldr r0, _08006500 @ =gComputedBgBuffer
	ldr r0, [r0]
	adds r3, r0, #2
	b _08006538
	.align 2, 0
...
_08006500: .4byte gComputedBgBuffer
_08006504:
	ldr r0, _0800650C @ =gComputedBgBuffer
	ldr r3, [r0]
	b _08006538
	.align 2, 0
_0800650C: .4byte gComputedBgBuffer
_08006510:
	ldr r1, _08006528 @ =gUnknown_03002A80
	movs r0, #2
	strb r0, [r1]
	ldr r0, _0800652C @ =gComputedBgBuffer
	ldr r3, [r0]
	movs r0, #1
	ands r0, r7
	cmp r0, #0
...
_0800652C: .4byte gComputedBgBuffer
...
sub_800672C: @ 0x0800672C
	...
	cmp r0, #0
	beq _0800676C
	ldr r0, _08006768 @ =gComputedBgBuffer
	ldr r0, [r0]
	adds r7, r0, #2
	b _080067A0
	.align 2, 0
...
_08006768: .4byte gComputedBgBuffer
_0800676C:
	ldr r0, _08006774 @ =gComputedBgBuffer
	ldr r7, [r0]
	b _080067A0
	.align 2, 0
_08006774: .4byte gComputedBgBuffer
_08006778:
	ldr r1, _08006790 @ =gUnknown_03002A80
	movs r0, #2
	strb r0, [r1]
	ldr r0, _08006794 @ =gComputedBgBuffer
	ldr r7, [r0]
	movs r0, #1
	ands r0, r2
	cmp r0, #0
...
_08006794: .4byte gComputedBgBuffer
...
sub_8006DB4: @ 0x08006DB4
	...
	cmp r0, #0
	beq _08006E20
	ldr r0, _08006E1C @ =gComputedBgBuffer
	ldr r0, [r0]
	adds r4, r0, #2
	b _08006E54
	.align 2, 0
...
_08006E1C: .4byte gComputedBgBuffer
_08006E20:
	ldr r0, _08006E28 @ =gComputedBgBuffer
	ldr r4, [r0]
	b _08006E54
	.align 2, 0
_08006E28: .4byte gComputedBgBuffer
_08006E2C:
	ldr r1, _08006E44 @ =gUnknown_03002A80
	movs r0, #2
	strb r0, [r1]
	ldr r0, _08006E48 @ =gComputedBgBuffer
	ldr r4, [r0]
	movs r0, #1
	ands r0, r7
	cmp r0, #0
...
_08006E48: .4byte gComputedBgBuffer
...
sub_800724C: @ 0x0800724C
	...
	cmp r0, #0
	beq _080072B8
	ldr r0, _080072B4 @ =gComputedBgBuffer
	ldr r0, [r0]
	adds r5, r0, #2
	b _080072EC
	.align 2, 0
...
_080072B4: .4byte gComputedBgBuffer
_080072B8:
	ldr r0, _080072C0 @ =gComputedBgBuffer
	ldr r5, [r0]
	b _080072EC
	.align 2, 0
_080072C0: .4byte gComputedBgBuffer
_080072C4:
	ldr r1, _080072DC @ =gUnknown_03002A80
	movs r0, #2
	strb r0, [r1]
	ldr r0, _080072E0 @ =gComputedBgBuffer
	ldr r5, [r0]
	movs r0, #1
	ands r0, r7
	cmp r0, #0
...
_080072E0: .4byte gComputedBgBuffer
...
sub_80075D0: @ 0x080075D0
	...
	cmp r0, #0
	beq _08007634
	ldr r0, _08007630 @ =gComputedBgBuffer
	ldr r0, [r0]
	adds r4, r0, #2
	b _0800766C
	.align 2, 0
...
_08007630: .4byte gComputedBgBuffer
_08007634:
	ldr r0, _0800763C @ =gComputedBgBuffer
	ldr r4, [r0]
	b _0800766C
	.align 2, 0
_0800763C: .4byte gComputedBgBuffer
_08007640:
	ldr r1, _0800765C @ =gUnknown_03002A80
	movs r0, #2
	strb r0, [r1]
	ldr r0, _08007660 @ =gComputedBgBuffer
	ldr r4, [r0]
	movs r0, #1
	ands r0, r7
	adds r2, r1, #0
...
_08007660: .4byte gComputedBgBuffer
...
sub_8007738: @ 0x08007738
	...
	strb r3, [r0]
	ldr r0, _08007848 @ =gComputedBgBuffer
	lsls r1, r7, #2
	ldr r0, [r0]
	adds r1, r0, r1
	ldr r0, [sp]
...
_08007848: .4byte gComputedBgBuffer
...
sub_8007858: @ 0x08007858
	...
	strb r3, [r0]
	ldr r0, _080078CC @ =gComputedBgBuffer
	lsls r1, r5, #2
	ldr r0, [r0]
	adds r2, r0, r1
	subs r4, r4, r5
...
_080078CC: .4byte gComputedBgBuffer
...
sub_80078D4: @ 0x080078D4
	...
	mov r0, sp
	str r0, [r2]
	ldr r0, _08007954 @ =gComputedBgBuffer
	lsls r1, r5, #2
	ldr r0, [r0]
	adds r0, r0, r1
	str r0, [r2, #4]
...
_08007954: .4byte gComputedBgBuffer
...
sub_8007958: @ 0x08007958
	...
	strb r3, [r0]
	ldr r0, _08007A00 @ =gComputedBgBuffer
	lsls r1, r7, #2
	ldr r0, [r0]
	adds r2, r0, r1
	cmp r7, ip
...
_08007A00: .4byte gComputedBgBuffer
...
sub_8007A08: @ 0x08007A08
	...
	cmp r0, #0
	beq _08007A50
	ldr r0, _08007A4C @ =gComputedBgBuffer
	ldr r0, [r0]
	adds r2, r0, #2
	b _08007A88
	.align 2, 0
...
_08007A4C: .4byte gComputedBgBuffer
_08007A50:
	ldr r0, _08007A58 @ =gComputedBgBuffer
	ldr r2, [r0]
	b _08007A88
	.align 2, 0
_08007A58: .4byte gComputedBgBuffer
_08007A5C:
	ldr r1, _08007A78 @ =gUnknown_03002A80
	movs r0, #2
	strb r0, [r1]
	ldr r0, _08007A7C @ =gComputedBgBuffer
	ldr r2, [r0]
	movs r0, #1
	ands r0, r6
	adds r6, r1, #0
...
_08007A7C: .4byte gComputedBgBuffer
...
sub_8007AC0: @ 0x08007AC0
	...
	movs r1, #2
	strb r1, [r2]
	ldr r1, _08007B24 @ =gComputedBgBuffer
	lsls r2, r4, #1
	ldr r1, [r1]
	adds r2, r1, r2
...
_08007B24: .4byte gComputedBgBuffer
