...
start_vector:
	mov r0, #0x12
	msr cpsr_fc, r0
	ldr sp, _0203B038 @ =0x03007FA0
	mov r0, #0x1f
	msr cpsr_fc, r0
	ldr sp, _0203B034 @ =0x03007F00
	ldr r1, _0203B100 @ =0x03007FFC
	...
	b start_vector
	.align 2, 0
_0203B034: .4byte 0x03007F00
_0203B038: .4byte 0x03007FA0
...
sub_0203B3D8: @ 0x0203B3D8
	...
	ldr r1, [r0]
	ldr r0, _0203B438 @ ="A2NE" or "A2NP" for EUROPE
	cmp r1, r0
	bne _0203B45E
	movs r2, #0
	mov r1, sp
...
sub_0203B530: @ 0x0203B530
	...
	ldr r1, [r0]
	ldr r0, _0203B5FC @ ="A2NE" or "A2NP" for EUROPE
	cmp r1, r0
	bne _0203B5B0
	ldrh r0, [r2]
	movs r3, #0x80
