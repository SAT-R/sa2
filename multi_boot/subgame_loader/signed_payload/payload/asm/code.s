...
_entry:
	mov r0, #0x12
_0203B004:
	.byte 0x00, 0xF0, 0x29, 0xE1, 0x28, 0xD0, 0x9F, 0xE5, 0x1F, 0x00, 0xA0, 0xE3
	.byte 0x00, 0xF0, 0x29, 0xE1, 0x18, 0xD0, 0x9F, 0xE5, 0xE0, 0x10, 0x9F, 0xE5, 0x18, 0x00, 0x8F, 0xE2
	.byte 0x00, 0x00, 0x81, 0xE5, 0xD8, 0x10, 0x9F, 0xE5, 0x0F, 0xE0, 0xA0, 0xE1, 0x11, 0xFF, 0x2F, 0xE1
	.byte 0xF2, 0xFF, 0xFF, 0xEA, 0x00, 0x7F, 0x00, 0x03, 0xA0, 0x7F, 0x00, 0x03
...
_0203B0EC:
	strh r0, [r3, #2]
	ldr r1, _0203B108 @ =0x03000000
	add r1, r1, r2
	ldr r0, [r1]
	bx r0
_0203B100:
	.byte 0xFC, 0x7F, 0x00, 0x03, 0x6D, 0xB2, 0x03, 0x02
_0203B108: .4byte 0x03000000

	arm_func_start sub_0203b10c
sub_0203b10c: @ 0x0203B10C
	push {r4, r5, r6, r7, r8, sb, sl, fp}
	mov ip, #0x4000000
	ldr fp, _0203B148 @ =0x030005E0
	add sl, fp, #0x40
	mov sb, #1
	mov r8, #0
	strb r8, [ip, #0x208]
...
sub_0203b2f0: @ 0x0203B2F0
	...
	movs r0, #1
	strh r0, [r3]
	ldr r1, _0203B33C @ =0x03000000
	ldr r0, _0203B340 @ =0x030004C0
	str r0, [r1]
	ldr r4, _0203B344 @ =0x03000090
	ldr r0, [r4]
	movs r1, #0xf0
	lsls r1, r1, #4
	ands r0, r1
...
_0203B33C: .4byte 0x03000000
_0203B340: .4byte 0x030004C0
_0203B344: .4byte 0x03000090
_0203B348:
	movs r7, #2
	ldrh r0, [r6, #0x10]
	subs r1, r0, #2
...
_0203B37C:
	ldr r0, _0203B388 @ =0x02020000
	movs r1, #0x80
	lsls r1, r1, #0x12
	bl sub_0203c0c4
	b _0203B3C8
	.align 2, 0
_0203B388: .4byte 0x02020000
_0203B38C:
	ldr r0, _0203B39C @ =0x02020000
	movs r1, #0xc0
	lsls r1, r1, #0x13
	movs r2, #0x80
	lsls r2, r2, #7
...
_0203B3A0:
	...
	ldr r1, _0203B3B8 @ =0x02020000
	bl sub_0203c0c4
	b _0203B3C8
	.align 2, 0
_0203B3B4: .4byte 0x02033000
_0203B3B8: .4byte 0x02020000
_0203B3BC:
...
_0203B4CA:
	...
	movs r0, #1
	strh r0, [r3]
	ldr r1, _0203B524 @ =0x03000000
	ldr r0, _0203B528 @ =sub_0203bf5c
	str r0, [r1]
	ldr r1, _0203B52C @ =0x0203C280
	ldrh r0, [r5, #0x10]
	lsls r0, r0, #2
	adds r0, r0, r1
	ldr r1, [r0]
...
_0203B524: .4byte 0x03000000
_0203B528: .4byte sub_0203bf5c
_0203B52C: .4byte 0x0203C280
...
sub_0203b530: @ 0x0203B530
	...
	ldr r0, _0203B5D0 @ =0x0203C208
	str r0, [r1]
	ldr r0, _0203B5D4 @ =0x03000000
	str r0, [r1, #4]
	...
	str r0, [r1]
	ldr r2, _0203B5E0 @ =0x030000A0
	str r2, [r1, #4]
	ldr r0, _0203B5E4 @ =0x84000100
	str r0, [r1, #8]
	ldr r0, [r1, #8]
	ldr r0, _0203B5E8 @ =0x03007FFC
	str r2, [r0]
	movs r0, #0xa0
	str r0, [sp]
	mov r0, sp
...
_0203B5B0:
	...
	bx r0
	.align 2, 0
_0203B5C8: .4byte 0x030004A2
_0203B5CC: .4byte 0x040000D4
_0203B5D0: .4byte 0x0203C208
_0203B5D4: .4byte 0x03000000
_0203B5D8: .4byte 0x8400000D
_0203B5DC: .4byte sub_0203b03c
_0203B5E0: .4byte 0x030000A0
_0203B5E4: .4byte 0x84000100
_0203B5E8: .4byte 0x03007FFC
...
_0203B61E:
	...
	adds r0, #2
	strh r2, [r0]
	ldr r0, _0203B6A0 @ =0x0203EBC0
	movs r1, #0xa0
	lsls r1, r1, #0x13
	movs r2, #0x80
	lsls r2, r2, #1
	bl sub_0203c0c0
	ldr r0, _0203B6A4 @ =0x0203EDC0
...
_0203B6A0: .4byte 0x0203EBC0
_0203B6A4: .4byte 0x0203EDC0
_0203B6A8: .4byte 0x06008000
_0203B6AC: .4byte 0x0203F260
...
_0203B750: .4byte 0x0203C4A4
_0203B754: .4byte 0x0600C000
_0203B758: .4byte 0x000011D0
_0203B75C: .4byte 0x0203E844
...
sub_0203b7d0: @ 0x0203B7D0
	...
	movs r6, #4
_0203B7E6:
	ldr r0, _0203B810 @ =0x030004A0
	ldr r4, _0203B814 @ =0x03000040
	ldrb r2, [r5, #0x15]
	adds r1, r4, #0
	bl sub_0203b9b8
	str r0, [r7]
...
_0203B802:
	...
	bx r1
	.align 2, 0
_0203B80C: .4byte 0x03000090
_0203B810: .4byte 0x030004A0
_0203B814: .4byte 0x03000040
...
_0203BB88:
	...
	bx r0
	.align 2, 0
_0203BB90: .4byte 0x030005E0
_0203BB94: .4byte 0x03000810
...
sub_0203bba0: @ 0x0203BBA0
	...
	sub sp, #0x14
	str r0, [sp, #0xc]
	ldr r0, _0203BCAC @ =0x030007D0
	movs r4, #0
	str r4, [sp]
	bl sub_0203c0f0
	str r0, [sp, #4]
	ldr r0, _0203BCB0 @ =0x030005E0
	strb r4, [r0, #3]
	add r1, sp, #4
	mov sl, r1
	add r2, sp, #8
...
_0203BC90:
	...
	b _0203BCDA
	.align 2, 0
_0203BCAC: .4byte 0x030007D0
_0203BCB0: .4byte 0x030005E0
...
_0203BD74: .4byte 0x030005E0

	thumb_func_start sub_0203bd78
sub_0203bd78: @ 0x0203BD78
	push {r4, r5, r6, r7, lr}
	adds r2, r0, #0
	ldr r0, _0203BD94 @ =0x03000810
	ldrb r1, [r0, #1]
	adds r5, r0, #0
	cmp r1, #4
	bls _0203BD88
