...
_02002BEE:
	...
	cmp r2, #0xff
	bne _02002C90
	ldr r0, _02002C88 @ =gUnknown_03004D80
	add r0, r8
	ldrb r1, [r0]
	lsls r0, r1, #8
	orrs r1, r0
...
_02002C88: .4byte gUnknown_03004D80
...
_02002C90:
	...
	b _02002DC4
_02002C9E:
	ldr r0, _02002CF4 @ =gUnknown_03004D80
	add r0, r8
	mov ip, r0
...
_02002CB0:
	...
	b _02002DC4
	.align 2, 0
_02002CF4: .4byte gUnknown_03004D80
...
_02002D1A:
	...
	cmp r0, #0xff
	bne _02002D70
	ldr r0, _02002D64 @ =gUnknown_03004D80
	add r0, r8
	ldrb r1, [r0]
	lsls r0, r3, #1
	muls r0, r4, r0
...
_02002D64: .4byte gUnknown_03004D80
...
_02002D70:
	...
	cmp r4, r6
	bhi _02002DC4
	ldr r2, _02002DFC @ =gUnknown_03004D80
	add r8, r2
...
_02002DFC: .4byte gUnknown_03004D80
...
_02004424:
	...
	ldrb r0, [r4]
	strb r0, [r2]
	ldr r0, _02004450 @ =gUnknown_03004D60
	adds r0, r5, r0
	ldrb r1, [r4]
	strb r1, [r0]
	b _02004472
...
_02004450: .4byte gUnknown_03004D60
_02004454:
	...
	movs r1, #0xff
	strb r1, [r0, #6]
	ldr r2, _0200448C @ =gUnknown_03004D60
	adds r2, r5, r2
	ldrb r0, [r2]
	lsls r0, r0, #3
	adds r0, r0, r3
...
_020045F8:
	...
	bl CpuSet
	str r4, [sp, #8]
	ldr r1, _0200463C @ =gUnknown_03004D60
	ldr r0, [sp, #0xc]
	adds r2, r5, #0
	bl CpuSet
	b _02004664
...
_0200463C: .4byte gUnknown_03004D60
_02004640:
	movs r1, #1
	rsbs r1, r1, #0
	str r1, [sp, #8]
	...
	ldr r1, [sp, #0xc]
	str r1, [r0]
	ldr r1, _02004680 @ =gUnknown_03004D60
	str r1, [r0, #4]
	str r2, [r0, #8]
	ldr r0, [r0, #8]
_02004664:
...
_02004680: .4byte gUnknown_03004D60
...
sub_02004F24: @ 0x02004F24
	...
	strh r0, [r1, #4]
	ldr r3, _02004F94 @ =gUnknown_03004D80
	movs r0, #0x7f
	strb r0, [r3, #2]
...
_02004F94: .4byte gUnknown_03004D80
...
_0200516A:
	...
	strh r0, [r1]
	strh r0, [r1, #4]
	ldr r0, _020051D8 @ =IWRAM_START + 0x430
	adds r1, r3, r0
	ldrh r0, [r1]
	adds r0, #1
	strh r0, [r1]
	...
	cmp r0, #0xf0
	bls _02005240
	ldr r1, _020051DC @ =IWRAM_START + 0x434
	adds r0, r3, r1
	ldr r0, [r0]
	cmp r0, #0
	beq _0200521E
...
_020051D8: .4byte IWRAM_START + 0x430
_020051DC: .4byte IWRAM_START + 0x434
...
_02005240:
	...
	movs r0, #1
	mov r8, r0
	ldr r1, _02005288 @ =IWRAM_START + 0x430
	adds r7, r3, r1
_0200524A:
	...
	b _020052AC
	.align 2, 0
_02005288: .4byte IWRAM_START + 0x430
