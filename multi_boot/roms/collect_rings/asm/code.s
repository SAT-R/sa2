...
@ CreateMultiplayerSinglePakResultsScreen: @ 0x02004E54
@ 	push {r4, r5, lr}
@ 	adds r5, r0, #0
@ 	ldr r1, _02004ED4 @ =gMultiplayerMissingHeartbeats
@ 	movs r0, #0
@ 	strb r0, [r1, #3]
@ 	strb r0, [r1, #2]
@ 	strb r0, [r1, #1]
...
@ 	str r0, [r1]
@ 	ldr r0, _02004F00 @ =gMultiplayerLanguage
@ 	strb r4, [r0]
@ 	bl sub_8081FB0
@ 	lsls r0, r5, #0x10
@ 	asrs r0, r0, #0x10
...
sub_02005078: @ 0x02005078
	...
	orrs r0, r1
	strh r0, [r2]
	ldr r2, _020050F8 @ =gMultiplayerConnections
	...
	beq _02005136
	movs r7, #1
	ldr r5, _02005104 @ =gMultiplayerMissingHeartbeats
_020050B6:
	adds r0, r7, #0
	lsls r0, r6
	ldr r4, [r3]
...
_020050F8: .4byte gMultiplayerConnections
_020050FC: .4byte gMultiSioStatusFlags
_02005100: .4byte gGameMode
_02005104: .4byte gMultiplayerMissingHeartbeats
...
_02005136:
	...
	cmp r0, #0
	beq _0200515C
	ldr r0, _02005158 @ =gMultiplayerLanguage
	ldrb r0, [r0]
	strb r0, [r2, #3]
	b _0200516A
	.align 2, 0
...
_02005158: .4byte gMultiplayerLanguage
_0200515C:
	ldr r2, _020051C8 @ =gMultiSioRecv
	ldrh r0, [r2]
	cmp r0, r4
	bne _0200516A
	ldr r1, _020051CC @ =gMultiplayerLanguage
	ldrb r0, [r2, #3]
	strb r0, [r1]
_0200516A:
...
_020051AC:
	...
	strh r0, [r4, #0x12]
	strh r7, [r4]
	ldr r0, _020051CC @ =gMultiplayerLanguage
	ldrb r0, [r0]
	cmp r0, #1
	bne _020051E8
	movs r0, #0x71
...
_020051CC: .4byte gMultiplayerLanguage
...
_0200524A:
	...
	cmp r0, #0
	bne _020052C2
	ldr r0, _02005290 @ =gUnknown_030054B4
	adds r0, r6, r0
	ldrb r1, [r0]
	mov r0, r8
	ands r0, r1
...
_02005290: .4byte gUnknown_030054B4
_02005294:
	lsls r1, r6, #2
	adds r1, r1, r6
	lsls r5, r1, #3
...
_020052AC:
	...
	b _0200533A
_020052C2:
	ldr r0, _02005304 @ =gUnknown_030054B4
	adds r2, r6, r0
	ldrb r1, [r2]
	mov r0, r8
	ands r0, r1
	...
	b _02005338
	.align 2, 0
_02005304: .4byte gUnknown_030054B4
_02005308:
	movs r0, #0
	ldrsb r0, [r2, r0]
	lsls r4, r0, #2
...
sub_02006168: @ 0x02006168
	...
	movs r0, #1
	strb r0, [r4, #0x14]
	ldr r0, _020061C0 @ =gEntitiesManagerTask
	str r6, [r0]
	add sp, #4
	pop {r4, r5, r6}
	pop {r0}
...
_020061C0: .4byte gEntitiesManagerTask
...
_02006494: .4byte gGameMode
_02006498:
	ldr r0, _020064B8 @ =gStageFlags
	ldrh r1, [r0]
	movs r0, #0x40
	ands r0, r1
	cmp r0, #0
...
sub_02006F50: @ 0x02006F50
	...
	cmp r1, #0
	bne _02006FAE
	ldr r1, _02006FB8 @ =gMultiplayerPlayerTasks
...
_02006FAE:
	...
	b _02007248
	.align 2, 0
_02006FB4: .4byte gPlayer
_02006FB8: .4byte gMultiplayerPlayerTasks
...
sub_0200872C: @ 0x0200872C
	...
	mov sb, r0
	movs r2, #0
	ldr r0, _020087E4 @ =gMultiplayerConnections
	ldrb r0, [r0]
	movs r1, #1
	ands r0, r1
	cmp r0, #0
...
sub_02008B1C: @ 0x02008B1C
	...
	lsls r3, r3, #0x12
	adds r0, r1, r3
	ldr r2, _02008BB0 @ =gMultiplayerPlayerTasks
	ldrb r0, [r0]
	lsls r0, r0, #2
	adds r0, r0, r2
	ldr r0, [r0]
...
_02008BB0: .4byte gMultiplayerPlayerTasks
...
_020090EC:
	adds r0, r4, #0
	bl UpdateSpriteAnimation
	ldr r1, _02009108 @ =gMultiplayerPlayerTasks
	ldrb r0, [r5]
	lsls r0, r0, #2
	adds r0, r0, r1
	str r6, [r0]
...
_02009108: .4byte gMultiplayerPlayerTasks
...
sub_02009ADC: @ 0x02009ADC
	...
	adds r1, r1, r0
	str r1, [r3, #0xc]
	ldr r1, _02009B88 @ =gMultiplayerPlayerTasks
...
_02009B84: .4byte gPlayer
_02009B88: .4byte gMultiplayerPlayerTasks
...
_02009D38:
	...
	b _02009D64
	.align 2, 0
_02009D54: .4byte gPlayer
_02009D58:
	ldr r7, _02009D78 @ =gPlayer
	ldr r0, [r7, #0x20]
	movs r1, #2
	rsbs r1, r1, #0
	ands r0, r1
...
_02009D7C:
	...
	cmp r0, r1
	bne _02009E64
	ldr r3, _02009E1C @ =gPlayer
	ldr r3, [r3, #0x20]
	str r3, [sp, #0x14]
	ldr r5, _02009E1C @ =gPlayer
	ldr r5, [r5, #0x3c]
	str r5, [sp, #0x18]
	adds r5, r6, #0
	adds r5, #0x50
...
_02009DF4:
	...
	b _02009E3C
	.align 2, 0
_02009E1C: .4byte gPlayer
_02009E20: .4byte gGameMode
...
_02009FB8:
	...
	bx r1
	.align 2, 0
_02009FC8: .4byte gPlayer

	thumb_func_start sub_02009FCC
sub_02009FCC: @ 0x02009FCC
	push {r4, r5, r6, r7, lr}
	ldr r0, _0200A020 @ =gGameMode
	ldrb r0, [r0]
	cmp r0, #2
	bls _0200A018
	ldr r1, _0200A024 @ =gMultiplayerPlayerTasks
	ldr r0, [r1]
	ldr r7, _0200A028 @ =gPlayer
	cmp r0, #0
	beq _0200A008
	movs r6, #0xc0
	lsls r6, r6, #0x12
...
_0200A018:
	...
	bx r0
	.align 2, 0
_0200A020: .4byte gGameMode
_0200A024: .4byte gMultiplayerPlayerTasks
_0200A028: .4byte gPlayer
...
sub_0200A02C: @ 0x0200A02C
	...
	lsls r2, r2, #0x12
	adds r2, r0, r2
	ldr r1, _0200A050 @ =gMultiplayerPlayerTasks
	...
	bx r0
	.align 2, 0
_0200A050: .4byte gMultiplayerPlayerTasks
...
sub_0200A058: @ 0x0200A058
	...
	lsls r0, r0, #0x12
	adds r5, r1, r0
	ldr r0, _0200A0C8 @ =gGameMode
	ldrb r0, [r0]
	cmp r0, #5
	beq _0200A072
	movs r2, #0xf0
_0200A072:
	ldr r0, _0200A0CC @ =gRoomEventQueueWritePos
	ldr r1, _0200A0D0 @ =gRoomEventQueueSendPos
	ldrb r0, [r0]
	ldrb r1, [r1]
	cmp r0, r1
	bne _0200A0BE
...
_0200A0C8: .4byte gGameMode
_0200A0CC: .4byte gRoomEventQueueWritePos
_0200A0D0: .4byte gRoomEventQueueSendPos
