...
_0200D3A4:
	...
	str r0, [r5]
	ldr r0, _0200D4DC @ =gPlayerControls
	ldrh r2, [r0]
	ldrh r1, [r0, #2]
	orrs r2, r1
	ldrh r0, [r0, #4]
...
_0200D4BA:
	...
	movs r0, #0x7f
	strb r0, [r4]
	ldr r0, _0200D4E4 @ =gMPAttackEffect2Regs
	str r2, [r0]
...
_0200D4DC: .4byte gPlayerControls
_0200D4E0: .4byte 0x0000FFFF
_0200D4E4: .4byte gMPAttackEffect2Regs
...
_0200E234:
	...
	ldrb r2, [r1]
	str r3, [sp]
	ldr r1, _0200E250 @ =sub_801EE64
	str r1, [sp, #4]
	adds r1, r5, #0
	b _0200E2BE
	.align 2, 0
_0200E250: .4byte sub_801EE64
_0200E254:
	subs r0, r4, #2
	mov r2, ip
	movs r1, #0x16
	...
	movs r1, #0
	str r1, [sp]
	ldr r1, _0200E278 @ =sub_801EE64
	str r1, [sp, #4]
	adds r1, r5, #0
	bl sub_801E4E4
	b _0200E2CE
	.align 2, 0
_0200E278: .4byte sub_801EE64
_0200E27C:
	subs r0, r5, #2
	mov r2, ip
	movs r1, #0x16
	...
	movs r1, #0
	str r1, [sp]
	ldr r1, _0200E2A0 @ =sub_801ED24
	str r1, [sp, #4]
	adds r1, r4, #0
	bl sub_801E4E4
	b _0200E2CE
	.align 2, 0
_0200E2A0: .4byte sub_801ED24
_0200E2A4:
	adds r0, r5, #2
	mov r2, ip
	movs r1, #0x16
...
_0200E4BA:
	...
	cmp r1, #0x1c
	bne _0200E4D6
	ldr r0, _0200E4F4 @ =gUnknown_030054B0
	ldrb r0, [r0]
	cmp r0, #0
	beq _0200E4DA
_0200E4D6:
...
_0200E4F4: .4byte gUnknown_030054B0
...
sub_0200E724: @ 0x0200E724
	...
	movs r1, #0
	strh r6, [r0]
	ldr r0, _0200E7C4 @ =gSpecialRingCount
	strb r1, [r0]
...
_0200E7C4: .4byte gSpecialRingCount
...
_0200E904:
	...
	cmp r1, #0x1c
	bne _0200E920
	ldr r0, _0200E98C @ =gUnknown_030054B0
	ldrb r0, [r0]
	cmp r0, #0
	beq _0200E924
_0200E920:
...
_0200E98C: .4byte gUnknown_030054B0
