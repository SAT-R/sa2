...
sub_02013714: @ 0x02013714
	...
	lsls r7, r7, #0x18
_02013728:
	ldr r3, _02013770 @ =gUnknown_02015EFC
	adds r0, r6, r3
	ldrb r5, [r0]
	ldr r4, _02013774 @ =gUnknown_02015FB0
	movs r2, #0xf
	adds r0, r5, #0
	ands r0, r2
	lsls r0, r0, #2
...
sub_020137B8: @ 0x020137B8
	...
	cmp r0, #0
	beq _02013806
	ldr r5, _02013828 @ =gUnknown_02016D5C
	adds r6, r0, #0
_020137EA:
	ldr r4, [r5]
	ldr r1, [r5, #4]
...
sub_02013970: @ 0x02013970
	...
	cmp r0, #0
	beq _0201398E
	ldr r5, _02013998 @ =gUnknown_02016D5C
	adds r4, r0, #0
_02013980:
	ldr r0, [r5]
	bl sub_02014054
...
sub_020139A8: @ 0x020139A8
	...
	cmp r0, #0
	beq _020139C6
	ldr r5, _020139D0 @ =gUnknown_02016D5C
	adds r4, r0, #0
_020139B8:
	ldr r0, [r5]
	bl sub_0201377C
