...
_0201095E:
	...
	ldr r1, _02010980 @ =Player_8029074
	str r1, [r0]
	adds r0, r4, #0
	bl _call_via_r1
	pop {r4, r5, r6}
...
_02010980: .4byte Player_8029074

	thumb_func_start Player_8029074
Player_8029074: @ 0x02010984
	push {r4, r5, r6, lr}
	adds r4, r0, #0
	bl sub_80246DC
	adds r0, r4, #0
...
Player_TryInitSpindash: @ 0x02010D4C
	...
	movs r0, #0xb
	bl m4aSongNumStart
	ldr r1, _02010DC4 @ =Player_Spindash
	str r1, [r4]
	adds r0, r5, #0
	bl _call_via_r1
	movs r0, #1
...
_02010DC4: .4byte Player_Spindash
_02010DC8:
	movs r0, #0
_02010DCA:
	pop {r4, r5, r6}
...
sub_020118F8: @ 0x020118F8
	...
	ldr r1, _0201194C @ =Player_Spindash
	str r1, [r0]
	adds r0, r4, #0
	bl _call_via_r1
	pop {r4, r5}
...
_0201194C: .4byte Player_Spindash
