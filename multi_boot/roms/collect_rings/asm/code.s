...
sub_0200CCC0: @ 0x0200CCC0
	...
	cmp r3, #0
	blt _0200CCE8
	ldr r0, _0200CCE4 @ =gRefCollision
	ldr r0, [r0]
	ldr r0, [r0, #0x1c]
	subs r1, r0, #1
	adds r0, r3, #0
...
_0200CCEA:
	...
	cmp r4, #0
	blt _0200CD08
	ldr r0, _0200CD04 @ =gRefCollision
	ldr r0, [r0]
	ldr r0, [r0, #0x20]
	subs r0, #1
	adds r1, r4, #0
...
_0200CD0A:
	...
	subs r2, r6, r2
_0200CD32:
	ldr r0, _0200CDA4 @ =gRefCollision
	ldr r4, [r0]
	lsls r0, r3, #3
	ldr r1, [r4]
	adds r0, r0, r2
...
sub_0200CDB8: @ 0x0200CDB8
	...
	cmp r4, #0
	blt _0200CDE0
	ldr r0, _0200CDDC @ =gRefCollision
	ldr r0, [r0]
	ldr r0, [r0, #0x1c]
	subs r1, r0, #1
	adds r0, r4, #0
...
_0200CDE2:
	...
	cmp r3, #0
	blt _0200CE00
	ldr r0, _0200CDFC @ =gRefCollision
	ldr r0, [r0]
	ldr r0, [r0, #0x20]
	subs r1, r0, #1
	adds r0, r3, #0
...
_0200CE02:
	...
	subs r2, r6, r2
_0200CE2C:
	ldr r0, _0200CE8C @ =gRefCollision
	ldr r4, [r0]
	lsls r0, r3, #3
	ldr r1, [r4]
	adds r0, r0, r2
...
sub_0200CEA0: @ 0x0200CEA0
	...
	cmp r4, #0
	blt _0200CECC
	ldr r0, _0200CEC8 @ =gRefCollision
	ldr r0, [r0]
	ldr r0, [r0, #0x1c]
	subs r1, r0, #1
	adds r0, r4, #0
...
_0200CECE:
	...
	cmp r5, #0
	blt _0200CEEC
	ldr r0, _0200CEE8 @ =gRefCollision
	ldr r0, [r0]
	ldr r0, [r0, #0x20]
	subs r0, #1
	adds r1, r5, #0
...
_0200CEEE:
	...
	subs r3, r7, r3
_0200CF16:
	ldr r2, _0200CF8C @ =gRefCollision
	ldr r5, [r2]
	lsls r0, r6, #3
	ldr r1, [r5]
	adds r0, r0, r3
...
sub_0200CFE0: @ 0x0200CFE0
	...
	cmp r5, #0
	blt _0200D00C
	ldr r0, _0200D008 @ =gRefCollision
	ldr r0, [r0]
	ldr r0, [r0, #0x1c]
	subs r1, r0, #1
	adds r0, r5, #0
...
_0200D00E:
	...
	cmp r4, #0
	blt _0200D02C
	ldr r0, _0200D028 @ =gRefCollision
	ldr r0, [r0]
	ldr r0, [r0, #0x20]
	subs r1, r0, #1
	adds r0, r4, #0
...
_0200D02E:
	...
	subs r3, r6, r3
_0200D058:
	ldr r2, _0200D0BC @ =gRefCollision
	ldr r5, [r2]
	lsls r0, r7, #3
	ldr r1, [r5]
	adds r0, r0, r3
...
_0200D160:
	...
	adds r5, r1, #0
_0200D17A:
	ldr r0, _0200D1BC @ =gRefCollision
	ldr r4, [r0]
	mov r1, sb
	lsls r0, r1, #2
	adds r1, r4, #0
