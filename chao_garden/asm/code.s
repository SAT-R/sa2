...
_020034A4: .4byte gGameState
_020034A8: .4byte gUnknown_02021BC4
_020034AC:
	movs r6, #0
	ldr r0, _02003520 @ =gGameState
	adds r1, r0, #0
	adds r1, #0x37
	ldrb r0, [r1]
...
_02004FDC:
	cmp r7, #0
	beq _02004FF0
	ldr r0, _02004FEC @ =gGameState
	adds r0, #0xcc
	movs r1, #0x5e
	strb r1, [r0]
	bl _02005B36
	.align 2, 0
_02004FEC: .4byte gGameState
_02004FF0:
	ldr r3, _02005050 @ =gGameState
	add r0, sp, #4
	ldrb r1, [r0]
	lsls r1, r1, #0x18
	lsrs r2, r1, #0x1b
...
_020076D0: .4byte gGameState
_020076D4:
	ldr r0, _020076FC @ =gInput
	ldrh r1, [r0, #4]
	movs r0, #0x80
	lsls r0, r0, #2
	ands r0, r1
...
_02007A4C: .4byte gInput
_02007A50:
	ldr r2, _02007AC4 @ =gInput
	ldrh r1, [r2, #4]
	movs r0, #1
	ands r0, r1
	cmp r0, #0
...
_02007A88:
	...
	b _02007AFA
	.align 2, 0
_02007AC4: .4byte gInput
_02007AC8: .4byte gGameState
...
_02007BC8: .4byte gInput
_02007BCC:
	ldr r2, _02007C14 @ =gInput
	ldrh r1, [r2, #4]
	movs r6, #1
	movs r0, #1
	ands r0, r1
	...
	b _02007C3E
	.align 2, 0
_02007C14: .4byte gInput
_02007C18: .4byte gGameState
...
_02007D14: .4byte gInput
_02007D18:
	ldr r2, _02007D64 @ =gInput
	ldrh r1, [r2, #4]
	movs r6, #1
	movs r0, #1
	ands r0, r1
...
_02007D42:
	...
	b _02007D92
	.align 2, 0
_02007D64: .4byte gInput
_02007D68: .4byte gGameState
...
_02007EEC: .4byte gGameState
_02007EF0: .4byte gUnknown_0300150C
_02007EF4: .4byte gInput
...
_020080B8: .4byte gGameState
_020080BC: .4byte gUnknown_0300150C
_020080C0: .4byte gInput
...
_02008566:
	...
	b _0200858A
	.align 2, 0
_02008584: .4byte gGameState
_02008588:
	adds r0, r2, #1
_0200858A:
	strb r0, [r4, #0x1d]
	ldr r0, _020085DC @ =gGameState
	ldrb r1, [r4, #0x1d]
	adds r0, #0x34
	strb r1, [r0]
_02008594:
...
_02009D7C: .4byte gInput
_02009D80:
	ldr r0, _02009DC0 @ =gInput
	ldrh r1, [r0, #4]
	movs r0, #0x40
	ands r0, r1
	cmp r0, #0
...
_0200D6C0: .4byte gInput
_0200D6C4:
	ldr r2, _0200D6F4 @ =gInput
	ldrh r1, [r2, #4]
	movs r0, #0xb
	ands r0, r1
	cmp r0, #0
