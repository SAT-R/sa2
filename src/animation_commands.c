...
static int animCmd_PlaySoundEffect(s32 *variantCursor, struct UNK_0808B3FC_UNK240 *sprite);
extern int animCmd_6(s32 *variantCursor, struct UNK_0808B3FC_UNK240 *sprite);
static int animCmd_TranslateSprite(s32 *variantCursor, struct UNK_0808B3FC_UNK240 *sprite);
...
int animCmd_GetPalette(s32 *variantCursor, struct UNK_0808B3FC_UNK240 *sprite) {
    ...
    if(!(sprite->unk10 & 0x40000)) {
        ...
        DmaCopy32(3,
                  &gUnknown_03002794->palettes[paletteIndex * 16],
