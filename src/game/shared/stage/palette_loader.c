...
Task *CreatePaletteLoaderTask(u16 priority, AnimId anim, u8 variant, TaskDestructor dtor)
{
    Task *t = TaskCreate(Task_StagePaletteLoader, sizeof(Sprite), priority, 0, dtor);
