...
const s8 gUnknown_080D5A98[NUM_LEVEL_IDS][4] = {
    { 0x20, 0x20, 0x02, 0x1D }, { 0x20, 0x20, 0x02, 0x1D }, { 0x20, 0x20, 0x02, 0x1D },
    { 0x20, 0x20, 0x02, 0x1D }, { 0x20, 0x40, 0x02, 0x1C }, { 0x20, 0x40, 0x02, 0x1C },
    { 0x20, 0x40, 0x02, 0x1C }, { 0x20, 0x20, 0x02, 0x1D }, { 0x20, 0x20, 0x02, 0x1D },
    { 0x20, 0x20, 0x02, 0x1D }, { 0x20, 0x20, 0x02, 0x1D }, { 0x20, 0x20, 0x02, 0x1D },
    { 0x20, 0x40, 0x02, 0x1C }, { 0x20, 0x40, 0x02, 0x1C }, { 0x20, 0x20, 0x02, 0x1D },
    { 0x20, 0x20, 0x02, 0x1D }, { 0x20, 0x20, 0x02, 0x1D }, { 0x20, 0x20, 0x02, 0x1D },
    { 0x20, 0x20, 0x02, 0x1D }, { 0x20, 0x20, 0x02, 0x1D }, { 0x20, 0x40, 0x02, 0x1C },
    { 0x40, 0x20, 0x02, 0x1C }, { 0x20, 0x20, 0x02, 0x1D }, { 0x20, 0x20, 0x02, 0x1D },
    { 0x20, 0x20, 0x02, 0x1D }, { 0x20, 0x20, 0x02, 0x1C }, { 0x20, 0x20, 0x02, 0x1D },
    { 0x20, 0x20, 0x02, 0x1D }, { 0x20, 0x20, 0x02, 0x1C }, { 0x20, 0x20, 0x02, 0x1D },
    { 0x20, 0x20, 0x02, 0x1D }, { 0x20, 0x40, 0x02, 0x1C }, { 0x20, 0x20, 0x02, 0x1D },
    { 0x40, 0x20, 0x02, 0x1C },
};

const u8 gUnknown_080D5B20[]
    = { 14, 0,   1,  22, 0,   3,  30, 0,   2,  38, 0,   1,   46, 0,   3,   62,
        0,  1,   70, 0,  2,   86, 0,  1,   94, 0,  2,   126, 0,  1,   168, 1,
        1,  174, 1,  2,  182, 2,  3,  198, 3,  4,  222, 4,   5,  255, 5,   6 };
...
const u8 gUnknown_080D5B50[160] = {
    ...
    10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10,
    10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10,
    10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 8, 8, 8, 8, 7, 7, 7, 7, 6, 6,

    // 106-159 | This data appears to be unused
    6, 6, 6, 6, 6, 6, 5, 5, 5, 5, 5, 5, 5, 5, 4, 4, 4, 4, 4, 4, 4, 4, 3, 3, 3, 3, 3, 3,
...
const u8 gUnknown_080D5C02[]
    = { 0x1F, 0x00, 0x1F, 0x01, 0x07, 0x14, 0x01, 0x09, 0x14, 0x00, 0x0A, 0x13,
        0x00, 0x0C, 0x13, 0x00, 0x0D, 0x12, 0x00, 0x0F, 0x12, 0x00, 0x10, 0x11,
        0x00, 0x12, 0x10, 0x00, 0x13, 0x10, 0x00, 0x15, 0x0F, 0x00, 0x16, 0x0F,
        0x00, 0x18, 0x0E, 0x00, 0x19, 0x0E, 0x00, 0x1B, 0x0D, 0x1F, 0x07, 0x00,
        0x1F, 0x00, 0x00, 0x0F, 0x00, 0x1B, 0x0E, 0x00, 0x19, 0x0D, 0x01, 0x17,
        0x0C, 0x01, 0x15, 0x0B, 0x02, 0x13, 0x0A, 0x02, 0x11, 0x08, 0x03, 0x0F,
        0x07, 0x03, 0x0D, 0x06, 0x04, 0x0B, 0x05, 0x04, 0x09, 0x04, 0x05, 0x07,
        0x03, 0x05, 0x05, 0x02, 0x06, 0x03, 0x01, 0x06, 0x01, 0x00, 0x07, 0x00 };

const s16 gUnknown_080D5C62[16] = {
    -Q_8_8(3.00), -Q_8_8(0.25), -Q_8_8(1.50), +Q_8_8(0.00),

    -Q_8_8(3.00), -Q_8_8(0.25), -Q_8_8(1.00), -Q_8_8(0.0859375),

    -Q_8_8(3.00), -Q_8_8(0.25), -Q_8_8(1.50), +Q_8_8(0.00),

    -Q_8_8(3.00), -Q_8_8(0.25), -Q_8_8(0.75), -Q_8_8(0.125),

};
const u16 gUnknown_080D5C82[16] = INCBIN_U16("graphics/080D5C82.gbapal");
const u16 gUnknown_080D5CA2[16] = INCBIN_U16("graphics/080D5CA2.gbapal");
