...
#include "game/special_stage/special_stage_world.h"
#include "game/special_stage/special_stage_collectables.h"
#include "game/special_stage/special_stage_guard_robo.h"
#include "game/special_stage/special_stage_physics.h"
