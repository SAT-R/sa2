...
#include "game/special_stage/special_stage_player.h"
#include "game/special_stage/special_stage_ui.h"
#include "game/special_stage/special_stage_utils.h"
#include "game/special_stage/special_stage_data.h"
#include "lib/m4a.h"
#include "game/save.h"
...
void sub_807061C(s16 a)
{
    ...
    if (stage->targetReached) {
        element->x = resultsScreen->unk516 + 0x4C;
        element = &resultsScreen->unk34;
        element->x = resultsScreen->unk516 + 4;
    } else {
        element->x = resultsScreen->unk516 + 0x30;
    }
}
...
void sub_80706D8(s16 a)
{
    ...
    element->x = resultsScreen->unk51A + 0x30;
...
void sub_8070740(s16 a)
{
    ...
    element->x = resultsScreen->unk51C + 0x30;
...
void sub_80707A8(s16 xPos)
{
    ...
    element->x = resultsScreen->unk51E + 0x30;
