    ...
    if (!(player->moveState & MOVESTATE_400000)) {
        ...
        if (r1 != 0) {
            if (((r1 & 0x80000) && (ramp->unk3C & 2) && (player->speedAirX > -1))
                ...
                s32 temp8 = screenX + displayed->hitboxes[0].left;
                s32 temp2 = displayed->hitboxes[0].right - displayed->hitboxes[0].left;
                ...
                if (temp9 > 0) {
                    if (temp9 > temp2) {
                        ...
                        s32 temp6 = Q_24_8_TO_INT(displayed->hitboxes[0].top
                                                  * (Q_24_8(temp9) / temp2));
