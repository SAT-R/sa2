...
// This object is placed on loops you attach onto while moving upwards
// eg. the loop after the vertical red spring in LS1
// Collision is not programmed to allow sticking onto ceiling slopes
