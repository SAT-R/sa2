...
static void Create_Toggle_Gravity(MapEntity *, u16, u16, u8, u8);
...
static void Create_Toggle_Gravity(MapEntity *in_ia, u16 spriteRegionX, u16 spriteRegionY,
                                  u8 spriteY, u8 toggleKind)
{
...
void Create_Toggle_Gravity__Down(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY,
                                 u8 spriteY)
{
    Create_Toggle_Gravity(me, spriteRegionX, spriteRegionY, spriteY,
                          GRAVITY_TOGGLE__DOWN);
}

void Create_Toggle_Gravity__Up(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY,
                               u8 spriteY)
{
    Create_Toggle_Gravity(me, spriteRegionX, spriteRegionY, spriteY, GRAVITY_TOGGLE__UP);
}

void Create_Toggle_Gravity__Toggle(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY,
                                   u8 spriteY)
{
    Create_Toggle_Gravity(me, spriteRegionX, spriteRegionY, spriteY,
