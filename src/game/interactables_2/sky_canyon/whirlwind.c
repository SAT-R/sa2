...
void Create_Whirlwind(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY,
                      u32 kind)
{
...
void Create_Whirlwind_0(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    Create_Whirlwind(me, spriteRegionX, spriteRegionY, spriteY, 0);
}

void Create_Whirlwind_1(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    Create_Whirlwind(me, spriteRegionX, spriteRegionY, spriteY, 1);
}
