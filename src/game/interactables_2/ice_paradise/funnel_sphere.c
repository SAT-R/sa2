...
static void sub_8078170(Sprite_FunnelSphere *funnelSphere)
{
    ...
    switch (gPlayer.character) {
        ...
        case CHARACTER_TAILS:
            ...
            gPlayer.unk94->s.unk10 |= SPRITE_FLAG_PRIORITY(1);
        ...
        case CHARACTER_AMY:
            ...
            gPlayer.unk90->s.unk10 |= SPRITE_FLAG_PRIORITY(1);
    }
...
static void sub_8078254(Sprite_FunnelSphere *funnelSphere)
{
    ...
    switch (gPlayer.character) {
        ...
        case CHARACTER_TAILS:
            gPlayer.unk94->s.unk10 &= ~SPRITE_FLAG_MASK_PRIORITY;
            gPlayer.unk94->s.unk10 |= SPRITE_FLAG_PRIORITY(funnelSphere->unk14);
        case CHARACTER_SONIC:
        case CHARACTER_KNUCKLES:
        case CHARACTER_AMY:
            gPlayer.unk90->s.unk10 &= ~SPRITE_FLAG_MASK_PRIORITY;
            gPlayer.unk90->s.unk10 |= SPRITE_FLAG_PRIORITY(funnelSphere->unk12);
    }
...
void Create_FunnelSphere(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
