...
static const u16 sResultsScreenBgSelectedCharacters[] = {
    [LANG_DEFAULT] = TM_MP_CHARACTERS_SELECTED_JP, [LANG_JAPANESE] = TM_MP_CHARACTERS_SELECTED_JP, [LANG_ENGLISH] = TM_MP_CHARACTERS_SELECTED_EN,
    [LANG_GERMAN] = TM_MP_CHARACTERS_SELECTED_DE,  [LANG_FRENCH] = TM_MP_CHARACTERS_SELECTED_FR,   [LANG_SPANISH] = TM_MP_CHARACTERS_SELECTED_ES,
