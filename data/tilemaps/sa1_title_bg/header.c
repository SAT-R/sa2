...
ALIGNED(4)
static const u16 Palette_sa1_title_bg[]
    = INCBIN_U16("data/tilemaps/sa1_title_bg/palette.gbapal");
ALIGNED(4)
static const u8 Tiles_sa1_title_bg[]
    = INCBIN_U8("data/tilemaps/sa1_title_bg/tiles.4bpp");
ALIGNED(4)
static const u16 Tilemap_sa1_title_bg[]
