...
ALIGNED(4)
static const u16 Palette_mp_orange_bg[]
    = INCBIN_U16("data/tilemaps/mp_orange_bg/palette.gbapal");
ALIGNED(4)
static const u8 Tiles_mp_orange_bg[]
    = INCBIN_U8("data/tilemaps/mp_orange_bg/tiles.4bpp");
ALIGNED(4)
static const u16 Tilemap_mp_orange_bg[]
