...
ALIGNED(4)
static const u16 Palette_storyframe_sonic_catches_vanilla[]
    = INCBIN_U16("data/tilemaps/storyframe_sonic_catches_vanilla/palette.gbapal");
ALIGNED(4)
static const u8 Tiles_storyframe_sonic_catches_vanilla[]
    = INCBIN_U8("data/tilemaps/storyframe_sonic_catches_vanilla/tiles.4bpp");
ALIGNED(4)
static const u16 Tilemap_storyframe_sonic_catches_vanilla[]
