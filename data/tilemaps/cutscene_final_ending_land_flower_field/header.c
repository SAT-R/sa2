...
ALIGNED(4)
static const u16 Palette_cutscene_final_ending_land_flower_field[]
    = INCBIN_U16("data/tilemaps/cutscene_final_ending_land_flower_field/palette.gbapal");
ALIGNED(4)
static const u8 Tiles_cutscene_final_ending_land_flower_field[]
    = INCBIN_U8("data/tilemaps/cutscene_final_ending_land_flower_field/tiles.4bpp");
ALIGNED(4)
static const u16 Tilemap_cutscene_final_ending_land_flower_field[] = INCBIN_U16(
