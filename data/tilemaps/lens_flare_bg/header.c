...
ALIGNED(4)
static const u16 Palette_lens_flare_bg[]
    = INCBIN_U16("data/tilemaps/lens_flare_bg/palette.gbapal");
ALIGNED(4)
static const u8 Tiles_lens_flare_bg[]
    = INCBIN_U8("data/tilemaps/lens_flare_bg/tiles.4bpp");
ALIGNED(4)
static const u16 Tilemap_lens_flare_bg[]
