...
ALIGNED(4)
static const u16 Palette_cutscene_vanilla_kidnapped_full_map_copy[] = INCBIN_U16(
    "data/tilemaps/cutscene_vanilla_kidnapped_full_map_copy/palette.gbapal");
ALIGNED(4)
static const u8 Tiles_cutscene_vanilla_kidnapped_full_map_copy[]
    = INCBIN_U8("data/tilemaps/cutscene_vanilla_kidnapped_full_map_copy/tiles.4bpp");
ALIGNED(4)
static const u16 Tilemap_cutscene_vanilla_kidnapped_full_map_copy[] = INCBIN_U16(
