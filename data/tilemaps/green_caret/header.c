...
ALIGNED(4)
static const u16 Palette_green_caret[]
    = INCBIN_U16("data/tilemaps/green_caret/palette.gbapal");
ALIGNED(4)
static const u8 Tiles_green_caret[] = INCBIN_U8("data/tilemaps/green_caret/tiles.4bpp");
ALIGNED(4)
static const u16 Tilemap_green_caret[]
