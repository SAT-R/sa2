...
ALIGNED(4)
static const u16 Palette_zone_3_act_1_bg[]
    = INCBIN_U16("data/tilemaps/zone_3_act_1_bg/palette.gbapal");
ALIGNED(4)
static const u8 Tiles_zone_3_act_1_bg[]
    = INCBIN_U8("data/tilemaps/zone_3_act_1_bg/tiles.4bpp");
ALIGNED(4)
static const u16 Tilemap_zone_3_act_1_bg[]
