...
ALIGNED(4)
static const u16 Palette_unlocked_amy_jp[]
    = INCBIN_U16("data/tilemaps/unlocked_amy_jp/palette.gbapal");
ALIGNED(4)
static const u8 Tiles_unlocked_amy_jp[]
    = INCBIN_U8("data/tilemaps/unlocked_amy_jp/tiles.4bpp");
ALIGNED(4)
static const u16 Tilemap_unlocked_amy_jp[]
