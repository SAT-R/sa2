...
ALIGNED(4)
static const u16 Palette_mp_character_selected_tails_bg[]
    = INCBIN_U16("data/tilemaps/mp_character_selected_tails_bg/palette.gbapal");
ALIGNED(4)
static const u8 Tiles_mp_character_selected_tails_bg[]
    = INCBIN_U8("data/tilemaps/mp_character_selected_tails_bg/tiles.4bpp");
ALIGNED(4)
static const u16 Tilemap_mp_character_selected_tails_bg[]
