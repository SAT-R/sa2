...
ALIGNED(4)
static const u16 Palette_storyframe_knuckles_unlock_0_dlg_jp[]
    = INCBIN_U16("data/tilemaps/storyframe_knuckles_unlock_0_dlg_jp/palette.gbapal");
ALIGNED(4)
static const u8 Tiles_storyframe_knuckles_unlock_0_dlg_jp[]
    = INCBIN_U8("data/tilemaps/storyframe_knuckles_unlock_0_dlg_jp/tiles.4bpp");
ALIGNED(4)
static const u16 Tilemap_storyframe_knuckles_unlock_0_dlg_jp[]
