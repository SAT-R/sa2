...
ALIGNED(4)
static const u16 Palette_storyframe_cream_cheese_vanilla_happy[]
    = INCBIN_U16("data/tilemaps/storyframe_cream_cheese_vanilla_happy/palette.gbapal");
ALIGNED(4)
static const u8 Tiles_storyframe_cream_cheese_vanilla_happy[]
    = INCBIN_U8("data/tilemaps/storyframe_cream_cheese_vanilla_happy/tiles.4bpp");
ALIGNED(4)
static const u16 Tilemap_storyframe_cream_cheese_vanilla_happy[]
