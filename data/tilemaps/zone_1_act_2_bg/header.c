...
ALIGNED(4)
static const u16 Palette_zone_1_act_2_bg[]
    = INCBIN_U16("data/tilemaps/zone_1_act_2_bg/palette.gbapal");
ALIGNED(4)
static const u8 Tiles_zone_1_act_2_bg[]
    = INCBIN_U8("data/tilemaps/zone_1_act_2_bg/tiles.4bpp");
ALIGNED(4)
static const u16 Tilemap_zone_1_act_2_bg[]
