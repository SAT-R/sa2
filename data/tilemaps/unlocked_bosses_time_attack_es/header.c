...
ALIGNED(4)
static const u16 Palette_unlocked_bosses_time_attack_es[]
    = INCBIN_U16("data/tilemaps/unlocked_bosses_time_attack_es/palette.gbapal");
ALIGNED(4)
static const u8 Tiles_unlocked_bosses_time_attack_es[]
    = INCBIN_U8("data/tilemaps/unlocked_bosses_time_attack_es/tiles.4bpp");
ALIGNED(4)
static const u16 Tilemap_unlocked_bosses_time_attack_es[]
