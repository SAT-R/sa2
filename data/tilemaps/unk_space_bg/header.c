...
ALIGNED(4)
static const u16 Palette_unk_space_bg[]
    = INCBIN_U16("data/tilemaps/unk_space_bg/palette.gbapal");
ALIGNED(4)
static const u8 Tiles_unk_space_bg[]
    = INCBIN_U8("data/tilemaps/unk_space_bg/tiles.4bpp");
ALIGNED(4)
static const u16 Tilemap_unk_space_bg[]
