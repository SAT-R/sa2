...
const u8 Tiles_intro_water[] = INCBIN_U8("data/tilemaps/intro_water/tiles.8bpp");
const u8 Tilemap_intro_water[] = INCBIN_U8("data/tilemaps/intro_water/tilemap.tilemap1");
