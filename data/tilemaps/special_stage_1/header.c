...
ALIGNED(4)
static const u16 Palette_special_stage_1[]
    = INCBIN_U16("data/tilemaps/special_stage_1/palette.gbapal");
ALIGNED(4)
static const u8 Tiles_special_stage_1[]
    = INCBIN_U8("data/tilemaps/special_stage_1/tiles.4bpp");
ALIGNED(4)
static const u8 Tilemap_special_stage_1[]
    = INCBIN_U8("data/tilemaps/special_stage_1/tilemap.tilemap2");
