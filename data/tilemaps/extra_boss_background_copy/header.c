...
ALIGNED(4)
static const u16 Palette_extra_boss_background_copy[]
    = INCBIN_U16("data/tilemaps/extra_boss_background_copy/palette.gbapal");
ALIGNED(4)
static const u8 Tiles_extra_boss_background_copy[]
    = INCBIN_U8("data/tilemaps/extra_boss_background_copy/tiles.4bpp");
ALIGNED(4)
static const u16 Tilemap_extra_boss_background_copy[]
