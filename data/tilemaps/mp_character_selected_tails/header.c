...
ALIGNED(4)
static const u16 Palette_mp_character_selected_tails[]
    = INCBIN_U16("data/tilemaps/mp_character_selected_tails/palette.gbapal");
ALIGNED(4)
static const u8 Tiles_mp_character_selected_tails[]
    = INCBIN_U8("data/tilemaps/mp_character_selected_tails/tiles.4bpp");
ALIGNED(4)
static const u16 Tilemap_mp_character_selected_tails[]
