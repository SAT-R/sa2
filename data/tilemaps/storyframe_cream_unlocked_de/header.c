...
ALIGNED(4)
static const u16 Palette_storyframe_cream_unlocked_de[]
    = INCBIN_U16("data/tilemaps/storyframe_cream_unlocked_de/palette.gbapal");
ALIGNED(4)
static const u8 Tiles_storyframe_cream_unlocked_de[]
    = INCBIN_U8("data/tilemaps/storyframe_cream_unlocked_de/tiles.4bpp");
ALIGNED(4)
static const u16 Tilemap_storyframe_cream_unlocked_de[]
