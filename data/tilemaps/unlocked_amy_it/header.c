...
ALIGNED(4)
static const u16 Palette_unlocked_amy_it[]
    = INCBIN_U16("data/tilemaps/unlocked_amy_it/palette.gbapal");
ALIGNED(4)
static const u8 Tiles_unlocked_amy_it[]
    = INCBIN_U8("data/tilemaps/unlocked_amy_it/tiles.4bpp");
ALIGNED(4)
static const u16 Tilemap_unlocked_amy_it[]
