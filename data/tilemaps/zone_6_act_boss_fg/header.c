...
const u16 Palette_zone_6_act_boss_fg[]
...
const u8 Tileset_AnimTiles_zone_6_act_boss_fg[]
    = INCBIN_U8("data/tilemaps/zone_6_act_boss_fg/tileset_anim.4bpp");
const u8 CollHeightMap_zone_6_act_boss_fg[]
...
const u16 Map_zone_6_act_boss_fg0[]
    = INCBIN_U16("data/tilemaps/zone_6_act_boss_fg/map_front.bin");

const u16 Map_zone_6_act_boss_fg1[]
