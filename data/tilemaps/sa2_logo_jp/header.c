...
const u8 Tiles_sa2_logo_jp[] = INCBIN_U8("data/tilemaps/sa2_logo_jp/tiles.8bpp");
const u8 Tilemap_sa2_logo_jp[] = INCBIN_U8("data/tilemaps/sa2_logo_jp/tilemap.tilemap1");
