...
const u16 Palette_zone_4_act_2_bg[] = INCBIN_U16("data/maps/zone_4/act_2/tilemaps/bg/palette.gbapal");
const u8 Tiles_zone_4_act_2_bg[] = INCBIN_U8("data/maps/zone_4/act_2/tilemaps/bg/tiles.4bpp");
const u16 Tilemap_zone_4_act_2_bg[] = INCBIN_U16("data/maps/zone_4/act_2/tilemaps/bg/tilemap.tilemap2");
