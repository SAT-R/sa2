...
const u16 Palette_zone_2_act_boss_fg[]
...
const u16 CollFlags_zone_2_act_boss_fg[]
    = INCBIN_U16("data/maps/zone_2/act_boss/tilemaps/fg/flags.coll");
const u16 Metatiles_zone_2_act_boss_fg[]
    = INCBIN_U16("data/maps/zone_2/act_boss/tilemaps/fg/metatiles.tilemap2");

const u16 Map_zone_2_act_boss_fg0[]
    = INCBIN_U16("data/maps/zone_2/act_boss/tilemaps/fg/map_front.bin");

const u16 Map_zone_2_act_boss_fg1[]
    = INCBIN_U16("data/maps/zone_2/act_boss/tilemaps/fg/map_back.bin");
