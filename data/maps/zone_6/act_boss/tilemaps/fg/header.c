...
const u16 Palette_zone_6_act_boss_fg[]
    = INCBIN_U16("data/maps/zone_6/act_boss/tilemaps/fg/palette.gbapal");
const u8 Tileset_zone_6_act_boss_fg[]
    = INCBIN_U8("data/maps/zone_6/act_boss/tilemaps/fg/tileset.4bpp");
const u8 Tileset_AnimTiles_zone_6_act_boss_fg[]
    = INCBIN_U8("data/maps/zone_6/act_boss/tilemaps/fg/tileset_anim.4bpp");
...
const u16 Map_zone_6_act_boss_fg0[]
    = INCBIN_U16("data/maps/zone_6/act_boss/tilemaps/fg/map_front.bin");

const u16 Map_zone_6_act_boss_fg1[]
    = INCBIN_U16("data/maps/zone_6/act_boss/tilemaps/fg/map_back.bin");
