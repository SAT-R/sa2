...
const u16 Palette_zone_1_act_dummy_bg[]
    = INCBIN_U16("data/maps/zone_1/act_dummy/tilemaps/bg/palette.gbapal");
const u8 Tiles_zone_1_act_dummy_bg[]
    = INCBIN_U8("data/maps/zone_1/act_dummy/tilemaps/bg/tiles.4bpp");
const u16 Tilemap_zone_1_act_dummy_bg[]
    = INCBIN_U16("data/maps/zone_1/act_dummy/tilemaps/bg/tilemap.tilemap2");
