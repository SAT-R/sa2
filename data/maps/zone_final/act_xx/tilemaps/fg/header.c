...
const u16 Palette_zone_final_act_xx_fg[]
    = INCBIN_U16("data/maps/zone_final/act_xx/tilemaps/fg/palette.gbapal");
const u8 Tileset_zone_final_act_xx_fg[]
    = INCBIN_U8("data/maps/zone_final/act_xx/tilemaps/fg/tileset.4bpp");
const s8 CollHeightMap_zone_final_act_xx_fg[]
    = INCBIN_U8("data/maps/zone_final/act_xx/tilemaps/fg/height_map.coll");
const u8 CollTileRot_zone_final_act_xx_fg[]
    = INCBIN_U8("data/maps/zone_final/act_xx/tilemaps/fg/tile_rot.coll");
const u16 CollFlags_zone_final_act_xx_fg[]
    = INCBIN_U16("data/maps/zone_final/act_xx/tilemaps/fg/flags.coll");
const u16 Metatiles_zone_final_act_xx_fg[]
    = INCBIN_U16("data/maps/zone_final/act_xx/tilemaps/fg/metatiles.tilemap2");

const u16 Map_zone_final_act_xx_fg0[]
    = INCBIN_U16("data/maps/zone_final/act_xx/tilemaps/fg/map_front.bin");

const u16 Map_zone_final_act_xx_fg1[]
    = INCBIN_U16("data/maps/zone_final/act_xx/tilemaps/fg/map_back.bin");
